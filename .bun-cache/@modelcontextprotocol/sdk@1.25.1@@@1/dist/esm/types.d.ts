...
export declare const RELATED_TASK_META_KEY =
 ...
 */
export declare const ProgressTokenSchema: z.ZodUnion<
...
declare const RequestMetaSchema: z.ZodObject<
  {
     ...
     */
    "io.modelcontextprotocol/related-task": z.ZodOptional<
      z.ZodObject<
        {
          taskId: z.ZodString;
        },
 ...
 */
export declare const isTaskAugmentedRequestParams: (
  value: unknown,
 ...
 */
export declare const RequestIdSchema: z.ZodUnion<
  readonly [z.ZodString, z.ZodNumber]
>;
/**
...
export declare const JSONRPCRequestSchema: z.ZodObject<
  ...
  z.core.$strict
>;
export declare const isJSONRPCRequest: (
  value: unknown,
...
export declare const JSONRPCNotificationSchema: z.ZodObject<
  ...
  z.core.$strict
>;
export declare const isJSONRPCNotification: (
  value: unknown,
 ...
 */
export declare const isJSONRPCResultResponse: (
  value: unknown,
 ...
 */
export declare const isJSONRPCResponse: (
  value: unknown,
) => value is JSONRPCResultResponse;
/**
 ...
 */
export declare const isJSONRPCErrorResponse: (
  value: unknown,
) => value is JSONRPCErrorResponse;
/**
 * @deprecated Use {@link isJSONRPCErrorResponse} instead.
 */
export declare const isJSONRPCError: (
  value: unknown,
) => value is JSONRPCErrorResponse;
export declare const JSONRPCMessageSchema: z.ZodUnion<
  readonly [
    z.ZodObject<
      {
        method: z.ZodString;
...
>;
export declare const JSONRPCResponseSchema: z.ZodUnion<
  readonly [
    z.ZodObject<
      {
        jsonrpc: z.ZodLiteral<"2.0">;
...
export declare const ClientTasksCapabilitySchema: z.ZodObject<
  {
     ...
     */
    requests: z.ZodOptional<
      z.ZodObject<
        {
          /**
           * Task support for sampling requests.
           */
          sampling: z.ZodOptional<
            z.ZodObject<
              {
...
export declare const ClientCapabilitiesSchema: z.ZodObject<
  {
    experimental: z.ZodOptional<
      z.ZodRecord<z.ZodString, z.ZodCustom<object, object>>
    >;
    sampling: z.ZodOptional<
      z.ZodObject<
        {
                ...
                z.ZodObject<
                  {
                    ...
                    sampling: z.ZodOptional<
                      z.ZodObject<
                        {
                          createMessage: z.ZodOptional<
                            z.ZodCustom<object, object>
                          >;
                        },
                        z.core.$loose
                      >
...
export declare const InitializeRequestSchema: z.ZodObject<
  ...
  z.core.$strip
>;
export declare const isInitializeRequest: (
  value: unknown,
...
export declare const InitializedNotificationSchema: z.ZodObject<
  ...
  z.core.$strip
>;
export declare const isInitializedNotification: (
  value: unknown,
 ...
 */
export declare const CompatibilityCallToolResultSchema: z.ZodUnion<
  [
    z.ZodObject<
      {
        _meta: z.ZodOptional<
 ...
 */
export declare const SamplingContentSchema: z.ZodDiscriminatedUnion<
  [
    z.ZodObject<
      {
        type: z.ZodLiteral<"text">;
 ...
 */
export declare const SamplingMessageContentBlockSchema: z.ZodDiscriminatedUnion<
  [
    z.ZodObject<
      {
        type: z.ZodLiteral<"text">;
...
export declare const CreateMessageRequestParamsSchema: z.ZodObject<
  {
    ...
    messages: z.ZodArray<
      ...
      >
    >;
    modelPreferences: z.ZodOptional<
      z.ZodObject<
        {
          hints: z.ZodOptional<
            z.ZodArray<
...
export declare const LegacyTitledEnumSchemaSchema: z.ZodObject<
  ...
  z.core.$strip
>;
export declare const SingleSelectEnumSchemaSchema: z.ZodUnion<
  readonly [
    z.ZodObject<
      {
        type: z.ZodLiteral<"string">;
 ...
 */
export declare const MultiSelectEnumSchemaSchema: z.ZodUnion<
  readonly [
    z.ZodObject<
      {
        type: z.ZodLiteral<"array">;
 ...
 */
export declare const EnumSchemaSchema: z.ZodUnion<
  readonly [
    z.ZodObject<
      {
        type: z.ZodLiteral<"string">;
 ...
 */
export declare const PrimitiveSchemaDefinitionSchema: z.ZodUnion<
  readonly [
    z.ZodUnion<
      readonly [
        z.ZodObject<
 ...
 */
export declare const ElicitRequestParamsSchema: z.ZodUnion<
  readonly [
    z.ZodObject<
      {
        _meta: z.ZodOptional<
...
export declare const CompleteRequestSchema: z.ZodObject<
  ...
  z.core.$strip
>;
export declare function assertCompleteRequestPrompt(
  request: CompleteRequest,
): asserts request is CompleteRequestPrompt;
export declare function assertCompleteRequestResourceTemplate(
  request: CompleteRequest,
...
>;
export declare const ClientNotificationSchema: z.ZodUnion<
  readonly [
    z.ZodObject<
      {
        method: z.ZodLiteral<"notifications/cancelled">;
...
>;
export declare const ClientResultSchema: z.ZodUnion<
  readonly [
    z.ZodObject<
      {
        /**
...
>;
export declare const ServerRequestSchema: z.ZodUnion<
  readonly [
    z.ZodObject<
      {
        method: z.ZodLiteral<"ping">;
...
>;
export declare const ServerNotificationSchema: z.ZodUnion<
  readonly [
    z.ZodObject<
      {
        method: z.ZodLiteral<"notifications/cancelled">;
...
>;
export declare const ServerResultSchema: z.ZodUnion<
  readonly [
    z.ZodObject<
      {
        /**
