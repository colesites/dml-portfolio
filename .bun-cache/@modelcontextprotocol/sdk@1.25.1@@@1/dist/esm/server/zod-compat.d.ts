...
export type SchemaOutput<S> = S extends z3.ZodTypeAny
  ...
  : S extends z4.$ZodType
    ? z4.output<S>
    : never;
export type SchemaInput<S> = S extends z3.ZodTypeAny
  ? z3.input<S>
  : S extends z4.$ZodType
    ? z4.input<S>
    : never;
...
export declare function objectFromShape(
  shape: ZodRawShapeCompat,
): AnyObjectSchema;
export declare function safeParse<S extends AnySchema>(
  schema: S,
  data: unknown,
):
  | {
...
export declare function safeParseAsync<S extends AnySchema>(
  schema: S,
  data: unknown,
): Promise<
  | {
...
>;
export declare function getObjectShape(
 ...
 */
export declare function normalizeObjectSchema(
 ...
 */
export declare function getSchemaDescription(
  schema: AnySchema,
): string | undefined;
/**
