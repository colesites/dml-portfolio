...
oauthProvider = new simpleOAuthClientProvider_js_1.InMemoryOAuthClientProvider(
  OAUTH_CALLBACK_URL,
  clientMetadata,
  (redirectUrl) => {
    console.log(
...
async function elicitationRequestHandler(request) {
  ...
  console.log(
    `📥 Queueing elicitation request (queue size will be: ${elicitationQueue.length + 1})`,
  );
...
async function connect(url) {
  ...
  client.setNotificationHandler(
    types_js_1.ElicitationCompleteNotificationSchema,
    (notification) => {
