...
exports.setupAuthServer =
  exports.DemoInMemoryAuthProvider =
  exports.DemoInMemoryClientsStore =
    void 0;
...
const setupAuthServer = ({ authServerUrl, mcpServerUrl, strictResource }) => {
  ...
  const validateResource = strictResource
    ? (resource) => {
        ...
        const expectedResource = (0, auth_utils_js_1.resourceUrlFromServerUrl)(
          mcpServerUrl,
        );
