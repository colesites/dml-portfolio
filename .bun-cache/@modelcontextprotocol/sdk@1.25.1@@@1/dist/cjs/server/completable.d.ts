 ...
 */
export declare function completable<T extends AnySchema>(
  schema: T,
  complete: CompleteCallback<T>,
): CompletableSchema<T>;
/**
 ...
 */
export declare function isCompletable(
  schema: unknown,
): schema is CompletableSchema<AnySchema>;
/**
 * Gets the completer callback from a completable schema, if it exists.
 */
export declare function getCompleter<T extends AnySchema>(
  schema: T,
 ...
 */
export declare function unwrapCompletable<T extends AnySchema>(
