...
function parseImpl(url, step, suffixLookup, partialOptions, result) {
  ...
  if (!options.extractHostname) {
    ...
    result.hostname = (0, extract_hostname_1.default)(
      url,
      (0, is_valid_1.default)(url),
    );
  } else {
  ...
  // Extract domain
  result.domain = (0, domain_1.default)(
    result.publicSuffix,
    result.hostname,
    options,
  );
  ...
  result.domainWithoutSuffix = (0, domain_without_suffix_1.default)(
    result.domain,
    result.publicSuffix,
  );
  return result;
