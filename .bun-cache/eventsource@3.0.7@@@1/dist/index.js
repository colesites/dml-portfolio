...
class ErrorEvent extends Event {
  ...
  constructor(type, errorEventInitDict) {
    ...
    super(type),
      (this.code =
        (_a = errorEventInitDict == null ? void 0 : errorEventInitDict.code) !=
        null
          ? _a
          : void 0),
      (this.message =
        (_b =
          errorEventInitDict == null ? void 0 : errorEventInitDict.message) !=
        null
          ? _b
          : void 0);
  }
  ...
  constructor(url, eventSourceInitDict) {
    ...
    super(),
      ...
      __privateAdd(this, _onFetchResponse, async (response) => {
        ...
        if (
          ((_a2 = __privateGet(this, _onOpen)) == null ||
            _a2.call(this, openEvent),
 ...
 */,
  (getRequestOptions_fn = function () {
    ...
    const init = {
      ...
      cache: "no-store",
      signal:
        (_a = __privateGet(this, _controller)) == null ? void 0 : _a.signal,
    };
    return (
