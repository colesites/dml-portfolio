...
exports.loadTsconfig =
  exports.walkForTsConfig =
  exports.tsConfigLoader =
    void 0;
...
function walkForTsConfig(directory, readdirSync) {
  ...
  for (
    var _i = 0, filesToCheck_1 = filesToCheck;
    _i < filesToCheck_1.length;
    _i++
  ) {
...
function loadTsconfig(
  ...
  try {
    ...
    throw new Error(
      "".concat(configFilePath, " is malformed ").concat(e.message),
    );
  }
...
function loadTsconfigFromExtends(
  ...
  if (
    (_a = config.compilerOptions) === null || _a === void 0
      ? void 0
      : _a.baseUrl
  ) {
