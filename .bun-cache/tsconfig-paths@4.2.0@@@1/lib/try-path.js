...
exports.exhaustiveTypeException =
  exports.getStrippedPath =
  exports.getPathsToTry =
    void 0;
...
function getPathsToTry(extensions, absolutePathMappings, requestedModule) {
  ...
  for (
    ...
    if (starMatch !== undefined) {
      var _loop_1 = (physicalPathPattern) => {
        ...
        pathsToTry.push.apply(
          pathsToTry,
          extensions.map((e) => ({ type: "index", path: indexPath + e })),
        );
      };
