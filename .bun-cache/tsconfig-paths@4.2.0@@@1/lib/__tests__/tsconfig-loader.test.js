...
describe("walkForTsConfig", () => {
  it("should find tsconfig in starting directory", () => {
    ...
    var res = (0, tsconfig_loader_1.walkForTsConfig)(
...
describe("loadConfig", () => {
  it("should load a config", () => {
    ...
    var res = (0, tsconfig_loader_1.loadTsconfig)(
      "/root/dir1/tsconfig.json",
  ...
  it("should throw an error including the file path when encountering invalid JSON5", () => {
    expect(() =>
      (0, tsconfig_loader_1.loadTsconfig)(
        "/root/dir1/tsconfig.json",
        (path) => path === "/root/dir1/tsconfig.json",
        (_) => '{\n            "compilerOptions": {\n          }',
      ),
  ...
  it("should load a config with string extends and overwrite all options", () => {
    ...
    var res = (0, tsconfig_loader_1.loadTsconfig)(
      (0, path_1.join)("/root", "dir1", "tsconfig.json"),
  ...
  it("should load a config with string extends from node_modules and overwrite all options", () => {
    ...
    var baseConfigPath = (0, path_1.join)(
      "/root",
      "dir1",
      "node_modules",
      "my-package",
  ...
  it("should use baseUrl relative to location of extended tsconfig", () => {
    ...
    var secondConfigPath = (0, path_1.join)(
      "/root",
      "dir1",
      "second-config.json",
    );
    var thirdConfig = { extends: "../second-config.json" };
    var thirdConfigPath = (0, path_1.join)(
      "/root",
      "dir1",
      "dir2",
      "third-config.json",
    ...
    var res = (0, tsconfig_loader_1.loadTsconfig)(
      (0, path_1.join)("/root", "dir1", "dir2", "third-config.json"),
      (path) =>
  ...
  it("should load a config with array extends and overwrite all options", () => {
    ...
    var baseConfig2Path = (0, path_1.join)(
      "/root",
      "dir1",
      "base-config-2.json",
    );
    ...
    var baseConfig3Path = (0, path_1.join)(
      "/root",
      "dir1",
      "dir2",
      "base-config-3.json",
    ...
    var res = (0, tsconfig_loader_1.loadTsconfig)(
      (0, path_1.join)("/root", "tsconfig.json"),
      (path) =>
        [
          baseConfig1Path,
          baseConfig2Path,
