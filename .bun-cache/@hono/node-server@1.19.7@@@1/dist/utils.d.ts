...
declare function readWithoutBlocking(
  readPromise: Promise<ReadableStreamReadResult<Uint8Array>>,
): Promise<ReadableStreamReadResult<Uint8Array> | undefined>;
declare function writeFromReadableStreamDefaultReader(
...
declare function writeFromReadableStream(
  stream: ReadableStream<Uint8Array>,
  writable: Writable,
): Promise<undefined> | undefined;
declare const buildOutgoingHttpHeaders: (
