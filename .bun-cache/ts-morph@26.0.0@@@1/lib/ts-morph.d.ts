...
export type SourceFileReferencingNodes =
  | ImportDeclaration
  | ExportDeclaration
...
type ModuledNodeExtensionType = Node<ts.SourceFile | ts.ModuleDeclaration> &
  StatementedNode;
...
export declare function ImportAttributeNamedNode<
  T extends Constructor<ImportAttributeNamedNodeExtensionType>,
>(Base: T): Constructor<ImportAttributeNamedNode> & T;

export interface ImportAttributeNamedNode
  extends ImportAttributeNamedNodeSpecific,
    ReferenceFindableNode,
    RenameableNode {}

type ImportAttributeNamedNodeExtensionType =
  NamedNodeBaseExtensionType<ts.ImportAttributeName>;
export type ImportAttributeNamedNodeSpecific =
  NamedNodeSpecificBase<AssertionKey>;
...
export interface ModuleNamedNode
  extends ModuleNamedNodeSpecific,
    ReferenceFindableNode,
    RenameableNode {}
...
>(
  ...
  NamedNodeSpecificBase<CompilerNodeToWrappedType<TCompilerNode>>
> &
  U;
...
type PropertyNamedNodeExtensionType =
  NamedNodeBaseExtensionType<ts.PropertyName>;
...
declare const BindingElementBase: Constructor<DotDotDotTokenableNode> &
...
export type ClassPropertyTypes =
  | PropertyDeclaration
  | GetAccessorDeclaration
  | SetAccessorDeclaration;
export type ClassInstancePropertyTypes =
  | ClassPropertyTypes
  | ParameterDeclaration;
export type ClassInstanceMemberTypes =
  | MethodDeclaration
  | ClassInstancePropertyTypes;
export type ClassStaticPropertyTypes =
  | PropertyDeclaration
  | GetAccessorDeclaration
  | SetAccessorDeclaration;
export type ClassStaticMemberTypes =
  | MethodDeclaration
  | ClassStaticBlockDeclaration
  | ClassStaticPropertyTypes;
...
type ClassLikeDeclarationBaseSpecificExtensionType =
  Node<ts.ClassLikeDeclarationBase> &
    HeritageClauseableNode &
    ModifierableNode &
    NameableNode;
declare const ClassDeclarationBase: Constructor<ModuleChildableNode> &
...
export declare class ClassElement<
  T extends ts.ClassElement = ts.ClassElement,
> extends Node<T> {
  /** Removes the class member. */
  remove(): void;
}

declare const ClassExpressionBase: Constructor<ClassLikeDeclarationBase> &
...
declare const ClassStaticBlockDeclarationBase: Constructor<ChildOrderableNode> &
...
declare const ConstructorDeclarationBase: Constructor<ReferenceFindableNode> &
  ...
  typeof ClassElement;
declare const ConstructorDeclarationOverloadBase: Constructor<TypeParameteredNode> &
  Constructor<JSDocableNode> &
  Constructor<ChildOrderableNode> &
  Constructor<TextInsertableNode> &
  Constructor<ScopedNode> &
...
declare const GetAccessorDeclarationBase: Constructor<ChildOrderableNode> &
  Constructor<TextInsertableNode> &
...
declare const MethodDeclarationBase: Constructor<ChildOrderableNode> &
  Constructor<TextInsertableNode> &
  ...
  Constructor<PropertyNamedNode> &
  typeof ClassElement;
declare const MethodDeclarationOverloadBase: Constructor<JSDocableNode> &
  Constructor<ChildOrderableNode> &
  Constructor<TextInsertableNode> &
  Constructor<OverrideableNode> &
  Constructor<ScopedNode> &
...
declare const PropertyDeclarationBase: Constructor<ChildOrderableNode> &
  Constructor<OverrideableNode> &
  Constructor<AmbientableNode> &
  Constructor<DecoratableNode> &
  Constructor<AbstractableNode> &
...
declare const SetAccessorDeclarationBase: Constructor<ChildOrderableNode> &
  Constructor<TextInsertableNode> &
  Constructor<DecoratableNode> &
  Constructor<AbstractableNode> &
  Constructor<ScopedNode> &
...
export declare class CompilerCommentStatement
...
export declare class CompilerCommentClassElement
  extends CompilerCommentNode
...
export declare class CompilerCommentTypeElement
  extends CompilerCommentNode
...
export declare class CompilerCommentEnumMember
  extends CompilerCommentNode
  implements ts.Node {}

export type NodePropertyToWrappedType<
...
export type NodeParentType<NodeType extends ts.Node> =
  NodeType extends ts.SourceFile
    ? undefined
...
export declare class Node<NodeType extends ts.Node = ts.Node> {
   ...
   * @param condition - Condition.
   */
  getLastChildOrThrow<T extends Node>(
    condition?: (node: Node) => node is T,
    message?: string | (() => string),
  ): T;
  /**
   ...
   */
  static hasExpression<T extends Node>(
    node: T,
  ): node is T & {
   ...
   * @param node - Node to check.
   */
  static hasStructure<T extends Node>(
    node: T,
  ): node is T & {
  ...
  static isImportAttributeNamed<T extends Node>(
    node: T | undefined,
  ...
  static isJSDocTypeExpressionableTag<T extends Node>(
    node: T | undefined,
  ): node is JSDocTypeExpressionableTag &
          ...
          : T extends ts.AssignmentExpression<infer U>
            ...
            : T["kind"] extends keyof ImplementedKindToNodeMappings
              ...
              : T extends ts.SyntaxList
                ? SyntaxList
                : T extends ts.JSDocTypeExpression
                  ? JSDocTypeExpression
                  : T extends ts.JSDocType
                    ? JSDocType
                    : T extends ts.NodeWithTypeArguments
                                    ...
                                    : T extends ts.UnaryExpression
                                      ...
                                      : T extends ts.Expression
                                        ...
                                        : T extends ts.IterationStatement
                                          ? IterationStatement
                                          : T extends CompilerCommentStatement
                                            ? CommentStatement
                                            : T extends CompilerCommentClassElement
                                              ? CommentClassElement
                                              : T extends CompilerCommentTypeElement
                                                ? CommentTypeElement
                                                : T extends CompilerCommentObjectLiteralElement
                                                  ? CommentObjectLiteralElement
                                                  : T extends CompilerCommentEnumMember
                                                    ? CommentEnumMember
                                                    : T extends ts.TypeElement
                                                      ...
                                                      : T extends ts.Statement
                                                        ...
                                                        : T extends ts.ClassElement
                                                          ? ClassElement
                                                          : T extends ts.ObjectLiteralElement
                                                            ? ObjectLiteralElement
                                                            : Node<T>;
declare const DecoratorBase: Constructor<LeftHandSideExpressionedNode> &
  typeof Node;
...
type JSDocPropertyLikeTagExtensionType = Node<ts.JSDocPropertyLikeTag> &
  JSDocTag;
...
type JSDocTypeExpressionableTagExtensionType = Node<
  ts.Node & {
...
type JSDocTypeParameteredTagExtensionType = Node<
  ts.Node & {
    typeParameters: ts.NodeArray<ts.TypeParameterDeclaration>;
  }
> &
...
declare const JSDocFunctionTypeBase: Constructor<SignaturedDeclaration> &
  typeof JSDocType;
...
declare const JSDocOverloadTagBase: Constructor<JSDocTypeExpressionableTag> &
  typeof JSDocTag;
...
declare const JSDocParameterTagBase: Constructor<JSDocPropertyLikeTag> &
  typeof JSDocTag;
...
declare const JSDocPropertyTagBase: Constructor<JSDocPropertyLikeTag> &
  typeof JSDocTag;
...
declare const JSDocReturnTagBase: Constructor<JSDocTypeExpressionableTag> &
  typeof JSDocTag;
...
declare const JSDocSatisfiesTagBase: Constructor<JSDocTypeExpressionableTag> &
  typeof JSDocTag;
...
declare const JSDocSeeTagBase: Constructor<JSDocTypeExpressionableTag> &
  typeof JSDocTag;
...
declare const JSDocTemplateTagBase: Constructor<JSDocTypeParameteredTag> &
  typeof JSDocTag;
...
declare const JSDocThisTagBase: Constructor<JSDocTypeExpressionableTag> &
  typeof JSDocTag;
...
declare const JSDocThrowsTagBase: Constructor<JSDocTypeExpressionableTag> &
  typeof JSDocTag;
...
/** JS doc type node. */
export declare class JSDocType<
  T extends ts.JSDocType = ts.JSDocType,
> extends TypeNode<T> {}
...
declare const EnumDeclarationBase: Constructor<TextInsertableNode> &
...
declare const EnumMemberBase: Constructor<JSDocableNode> &
  Constructor<InitializerExpressionableNode> &
  Constructor<PropertyNamedNode> &
  typeof Node;
...
declare const AsExpressionBase: Constructor<TypedNode> &
...
export declare class AssignmentExpression<
  T extends
    ts.AssignmentExpression<ts.AssignmentOperatorToken> = ts.AssignmentExpression<ts.AssignmentOperatorToken>,
...
declare const AwaitExpressionBase: Constructor<UnaryExpressionedNode> &
...
declare const CallExpressionBase: Constructor<TypeArgumentedNode> &
...
declare const DeleteExpressionBase: Constructor<UnaryExpressionedNode> &
  typeof UnaryExpression;
...
declare const ElementAccessExpressionBase: Constructor<QuestionDotTokenableNode> &
  Constructor<LeftHandSideExpressionedNode> &
...
declare const LiteralExpressionBase: Constructor<LiteralLikeNode> &
  typeof PrimaryExpression;
...
declare const MetaPropertyBase: Constructor<NamedNode> &
  typeof PrimaryExpression;
...
declare const NewExpressionBase: Constructor<TypeArgumentedNode> &
  Constructor<ArgumentedNode> &
  Constructor<LeftHandSideExpressionedNode> &
  typeof PrimaryExpression;
...
declare const NonNullExpressionBase: Constructor<ExpressionedNode> &
  typeof LeftHandSideExpression;
...
declare const PropertyAssignmentBase: Constructor<InitializerExpressionGetableNode> &
  Constructor<QuestionTokenableNode> &
  Constructor<PropertyNamedNode> &
...
declare const ShorthandPropertyAssignmentBase: Constructor<InitializerExpressionGetableNode> &
  Constructor<QuestionTokenableNode> &
  Constructor<NamedNode> &
  typeof ObjectLiteralElement;
...
declare const SpreadAssignmentBase: Constructor<ExpressionedNode> &
  typeof ObjectLiteralElement;
...
declare const ParenthesizedExpressionBase: Constructor<ExpressionedNode> &
  typeof Expression;
...
declare const PartiallyEmittedExpressionBase: Constructor<ExpressionedNode> &
  typeof Expression;
...
declare const PropertyAccessExpressionBase: Constructor<NamedNode> &
  Constructor<QuestionDotTokenableNode> &
  Constructor<LeftHandSideExpressionedNode> &
  typeof MemberExpression;
...
declare const SatisfiesExpressionBase: Constructor<TypedNode> &
  Constructor<ExpressionedNode> &
  typeof Expression;
...
declare const SpreadElementBase: Constructor<ExpressionedNode> &
  typeof Expression;
...
declare const SuperElementAccessExpressionBase: Constructor<SuperExpressionedNode> &
...
declare const SuperPropertyAccessExpressionBase: Constructor<SuperExpressionedNode> &
...
declare const TypeAssertionBase: Constructor<TypedNode> &
...
export declare class TypeAssertion extends TypeAssertionBase<ts.TypeAssertion> {
  ...
  getParentOrThrow(
    message?: string | (() => string),
  ): NonNullable<NodeParentType<ts.TypeAssertion>>;
}

declare const TypeOfExpressionBase: Constructor<UnaryExpressionedNode> &
  typeof UnaryExpression;
...
export declare class TypeOfExpression extends TypeOfExpressionBase<ts.TypeOfExpression> {
  ...
  getParentOrThrow(
    message?: string | (() => string),
  ): NonNullable<NodeParentType<ts.TypeOfExpression>>;
}
...
declare const VoidExpressionBase: Constructor<UnaryExpressionedNode> &
  typeof UnaryExpression;
...
export declare class VoidExpression extends VoidExpressionBase<ts.VoidExpression> {
  ...
  getParentOrThrow(
    message?: string | (() => string),
  ): NonNullable<NodeParentType<ts.VoidExpression>>;
}

declare const YieldExpressionBase: Constructor<ExpressionableNode> &
  Constructor<GeneratorableNode> &
  typeof Expression;
...
export declare class YieldExpression extends YieldExpressionBase<ts.YieldExpression> {
  ...
  getParentOrThrow(
    message?: string | (() => string),
  ): NonNullable<NodeParentType<ts.YieldExpression>>;
}

declare const ArrowFunctionBase: Constructor<TextInsertableNode> &
  Constructor<BodiedNode> &
  Constructor<AsyncableNode> &
  Constructor<FunctionLikeDeclaration> &
  typeof Expression;
...
declare const FunctionDeclarationBase: Constructor<UnwrappableNode> &
  Constructor<TextInsertableNode> &
  Constructor<OverloadableNode> &
  Constructor<BodyableNode> &
  Constructor<AsyncableNode> &
  ...
  typeof Statement;
declare const FunctionDeclarationOverloadBase: Constructor<UnwrappableNode> &
  Constructor<TextInsertableNode> &
  Constructor<AsyncableNode> &
  Constructor<GeneratorableNode> &
  Constructor<SignaturedDeclaration> &
...
declare const FunctionExpressionBase: Constructor<JSDocableNode> &
  Constructor<TextInsertableNode> &
  Constructor<BodiedNode> &
  Constructor<AsyncableNode> &
  Constructor<GeneratorableNode> &
...
declare const ParameterDeclarationBase: Constructor<OverrideableNode> &
  Constructor<QuestionTokenableNode> &
  Constructor<DecoratableNode> &
...
declare const CallSignatureDeclarationBase: Constructor<TypeParameteredNode> &
  Constructor<ChildOrderableNode> &
  Constructor<JSDocableNode> &
  Constructor<SignaturedDeclaration> &
  typeof TypeElement;
...
declare const ConstructSignatureDeclarationBase: Constructor<TypeParameteredNode> &
  Constructor<ChildOrderableNode> &
  Constructor<JSDocableNode> &
  Constructor<SignaturedDeclaration> &
  typeof TypeElement;
...
declare const IndexSignatureDeclarationBase: Constructor<ReturnTypedNode> &
  Constructor<ChildOrderableNode> &
  Constructor<JSDocableNode> &
  Constructor<ReadonlyableNode> &
  Constructor<ModifierableNode> &
...
declare const InterfaceDeclarationBase: Constructor<TypeElementMemberedNode> &
  Constructor<TextInsertableNode> &
...
declare const MethodSignatureBase: Constructor<ChildOrderableNode> &
  Constructor<JSDocableNode> &
  Constructor<QuestionTokenableNode> &
  Constructor<TypeParameteredNode> &
  Constructor<SignaturedDeclaration> &
...
declare const PropertySignatureBase: Constructor<ChildOrderableNode> &
  Constructor<JSDocableNode> &
  Constructor<ReadonlyableNode> &
  Constructor<QuestionTokenableNode> &
  Constructor<InitializerExpressionableNode> &
...
export declare class TypeElement<
...
type JsxAttributedNodeExtensionType = Node<
  ts.Node & {
...
declare const JsxExpressionBase: Constructor<ExpressionableNode> &
  Constructor<DotDotDotTokenableNode> &
  typeof Expression;
...
declare const JsxOpeningElementBase: Constructor<JsxAttributedNode> &
...
declare const JsxSelfClosingElementBase: Constructor<JsxAttributedNode> &
  Constructor<JsxTagNamedNode> &
  typeof PrimaryExpression;
...
declare const JsxSpreadAttributeBase: Constructor<ExpressionedNode> &
  typeof Node;
...
declare const ExportAssignmentBase: Constructor<ExpressionedNode> &
  Constructor<JSDocableNode> &
  typeof Statement;
...
declare const ExternalModuleReferenceBase: Constructor<ExpressionableNode> &
  typeof Node;
...
declare const ImportAttributeBase: Constructor<ImportAttributeNamedNode> &
  typeof Node;
...
declare const ImportEqualsDeclarationBase: Constructor<ExportableNode> &
  Constructor<ModifierableNode> &
  Constructor<JSDocableNode> &
  Constructor<NamedNode> &
  typeof Statement;
...
declare const ModuleDeclarationBase: Constructor<ModuledNode> &
...
declare const SourceFileBase: Constructor<ModuledNode> &
  Constructor<StatementedNode> &
  Constructor<TextInsertableNode> &
  typeof Node;
...
>;
declare const ComputedPropertyNameBase: Constructor<ExpressionedNode> &
  typeof Node;
...
declare const IdentifierBase: Constructor<CommonIdentifierBase> &
...
declare const PrivateIdentifierBase: Constructor<CommonIdentifierBase> &
  Constructor<ReferenceFindableNode> &
  Constructor<RenameableNode> &
  typeof Node;
...
declare const BlockBase: Constructor<TextInsertableNode> &
  Constructor<StatementedNode> &
  typeof Statement;
...
declare const CaseClauseBase: Constructor<JSDocableNode> &
  Constructor<ExpressionedNode> &
  Constructor<TextInsertableNode> &
  Constructor<StatementedNode> &
  typeof Node;
...
declare const DefaultClauseBase: Constructor<TextInsertableNode> &
  Constructor<StatementedNode> &
  typeof Node;
...
declare const DoStatementBase: Constructor<ExpressionedNode> &
...
declare const ExpressionStatementBase: Constructor<ExpressionedNode> &
  Constructor<JSDocableNode> &
  typeof Statement;
...
declare const ForInStatementBase: Constructor<ExpressionedNode> &
  typeof IterationStatement;
...
declare const ForOfStatementBase: Constructor<ExpressionedNode> &
...
declare const LabeledStatementBase: Constructor<JSDocableNode> &
  typeof Statement;
...
declare const ReturnStatementBase: Constructor<ExpressionableNode> &
  typeof Statement;
...
export declare class Statement<
  T extends ts.Statement = ts.Statement,
...
declare const SwitchStatementBase: Constructor<ExpressionedNode> &
  typeof Statement;
...
declare const ThrowStatementBase: Constructor<ExpressionedNode> &
  typeof Statement;
...
declare const VariableStatementBase: Constructor<ModuleChildableNode> &
  Constructor<JSDocableNode> &
  Constructor<AmbientableNode> &
  Constructor<ExportableNode> &
  Constructor<ModifierableNode> &
...
export declare class VariableStatement extends VariableStatementBase<ts.VariableStatement> {
  ...
  getParentOrThrow(
    message?: string | (() => string),
  ): NonNullable<NodeParentType<ts.VariableStatement>>;
}

declare const WhileStatementBase: Constructor<ExpressionedNode> &
  typeof IterationStatement;
...
export declare class WhileStatement extends WhileStatementBase<ts.WhileStatement> {
  ...
  getParentOrThrow(
    message?: string | (() => string),
  ): NonNullable<NodeParentType<ts.WhileStatement>>;
}

declare const WithStatementBase: Constructor<ExpressionedNode> &
  typeof Statement;
...
export declare class WithStatement extends WithStatementBase<ts.WithStatement> {
  ...
  getParentOrThrow(
    message?: string | (() => string),
  ): NonNullable<NodeParentType<ts.WithStatement>>;
}
...
declare const ConstructorTypeNodeBase: Constructor<AbstractableNode> &
  Constructor<ModifierableNode> &
...
declare const ExpressionWithTypeArgumentsBase: Constructor<LeftHandSideExpressionedNode> &
...
declare const FunctionOrConstructorTypeNodeBaseBase: Constructor<SignaturedDeclaration> &
  typeof TypeNode;
...
declare const FunctionTypeNodeBase: Constructor<TypeParameteredNode> &
  typeof FunctionOrConstructorTypeNodeBase;
...
declare const NamedTupleMemberBase: Constructor<TypedNode> &
  Constructor<QuestionTokenableNode> &
  Constructor<DotDotDotTokenableNode> &
  Constructor<JSDocableNode> &
  Constructor<NamedNode> &
...
declare const TypeAliasDeclarationBase: Constructor<TypeParameteredNode> &
  Constructor<TypedNode> &
  Constructor<JSDocableNode> &
  Constructor<AmbientableNode> &
  Constructor<ExportableNode> &
...
export declare class TypeAliasDeclaration extends TypeAliasDeclarationBase<ts.TypeAliasDeclaration> {
  ...
  getParentOrThrow(
    message?: string | (() => string),
  ): NonNullable<NodeParentType<ts.TypeAliasDeclaration>>;
}

declare const TypeLiteralNodeBase: Constructor<TypeElementMemberedNode> &
  typeof TypeNode;
...
export declare class TypeLiteralNode extends TypeLiteralNodeBase<ts.TypeLiteralNode> {
  ...
  getParentOrThrow(
    message?: string | (() => string),
  ): NonNullable<NodeParentType<ts.TypeLiteralNode>>;
}
...
declare const NodeWithTypeArgumentsBase: Constructor<TypeArgumentedNode> &
  typeof TypeNode;
...
export declare class TypeOperatorTypeNode extends TypeNode<ts.TypeOperatorNode> {
  ...
  getParentOrThrow(
    message?: string | (() => string),
  ): NonNullable<NodeParentType<ts.TypeOperatorNode>>;
}
...
declare const TypeParameterDeclarationBase: Constructor<ModifierableNode> &
  Constructor<NamedNode> &
  typeof Node;
...
export declare class TypeParameterDeclaration extends TypeParameterDeclarationBase<ts.TypeParameterDeclaration> {
  ...
  getParentOrThrow(
    message?: string | (() => string),
  ): NonNullable<NodeParentType<ts.TypeParameterDeclaration>>;
}
...
export declare class TypePredicateNode extends TypeNode<ts.TypePredicateNode> {
  ...
  getParentOrThrow(
    message?: string | (() => string),
  ): NonNullable<NodeParentType<ts.TypePredicateNode>>;
}
...
export declare class TypeQueryNode extends NodeWithTypeArguments<ts.TypeQueryNode> {
  ...
  getParentOrThrow(
    message?: string | (() => string),
  ): NonNullable<NodeParentType<ts.TypeQueryNode>>;
}
...
export declare class TypeReferenceNode extends NodeWithTypeArguments<ts.TypeReferenceNode> {
  ...
  getParentOrThrow(
    message?: string | (() => string),
  ): NonNullable<NodeParentType<ts.TypeReferenceNode>>;
}
...
export declare class UnionTypeNode extends TypeNode<ts.UnionTypeNode> {
  ...
  getParentOrThrow(
    message?: string | (() => string),
  ): NonNullable<NodeParentType<ts.UnionTypeNode>>;
}

declare const VariableDeclarationBase: Constructor<ExportGetableNode> &
  Constructor<ExclamationTokenableNode> &
  Constructor<TypedNode> &
  Constructor<InitializerExpressionableNode> &
  Constructor<BindingNamedNode> &
...
export declare class VariableDeclaration extends VariableDeclarationBase<ts.VariableDeclaration> {
  ...
  getParentOrThrow(
    message?: string | (() => string),
  ): NonNullable<NodeParentType<ts.VariableDeclaration>>;
}
...
declare const VariableDeclarationListBase: Constructor<ModifierableNode> &
  typeof Node;
...
export declare class VariableDeclarationList extends VariableDeclarationListBase<ts.VariableDeclarationList> {
  ...
  getParentOrThrow(
    message?: string | (() => string),
  ): NonNullable<NodeParentType<ts.VariableDeclarationList>>;
}
...
export interface ImportAttributeStructure
  extends Structure,
    ImportAttributeStructureSpecificStructure,
    ImportAttributeNamedNodeStructure {}

interface ImportAttributeStructureSpecificStructure
  extends KindedStructure<StructureKind.ImportAttribute> {
...
export declare const Structure: {
  ...
  readonly isNameable: <T>(
    structure: T,
  ) => structure is T & NameableNodeStructure;
