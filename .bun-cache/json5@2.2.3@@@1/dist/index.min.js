!((u, D) => {
  ...
  var D = u((u) => {
    ...
    r =
      (e.version,
      (u) => ("object" == typeof u ? null !== u : "function" == typeof u)),
    t = (u) => {
    ...
    F = !n(() => 7 != Object.defineProperty({}, "a", { get: () => 7 }).a),
    C = D.document,
    ...
    l = u((u) => {
      ...
      (u.exports = (u, D) => r[u] || (r[u] = void 0 !== D ? D : {}))(
        "versions",
        [],
      ).push({
        version: e.version,
    ...
    v = (u, D, e) => {
      ...
      switch (e) {
        case 1:
          return (e) => u.call(D, e);
        case 2:
          return (e, r) => u.call(D, e, r);
        case 3:
          return (e, r, t) => u.call(D, e, r, t);
      }
    ...
    fromCodePoint: (u) => {
      for (
        ...
        n.push(
          D < 65536
            ? N(D)
            : N(55296 + ((D -= 65536) >> 10), (D % 1024) + 56320),
        );
      }
      return n.join("");
    },
  ...
  var _,
    ...
    U = {
      isSpaceSeparator: (u) =>
        "string" == typeof u && G.Space_Separator.test(u),
      isIdStartChar: (u) =>
        "string" == typeof u &&
        ((u >= "a" && u <= "z") ||
          (u >= "A" && u <= "Z") ||
  ...
  return {
    ...
    stringify: (u, D, e) => {
      ...
      function B(u) {
        ...
        var A = n || Object.keys(D).reduce((u, e) => (D[u] < D[e] ? u : e));
