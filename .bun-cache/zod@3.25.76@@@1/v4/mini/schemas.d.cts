...
export declare function email(
  params?: string | core.$ZodEmailParams,
): ZodMiniEmail;
...
export declare function guid(
  params?: string | core.$ZodGUIDParams,
): ZodMiniGUID;
...
export declare function uuid(
  params?: string | core.$ZodUUIDParams,
): ZodMiniUUID;
...
export declare function emoji(
  params?: string | core.$ZodEmojiParams,
): ZodMiniEmoji;
...
export declare function cuid(
  params?: string | core.$ZodCUIDParams,
): ZodMiniCUID;
...
export declare function cuid2(
  params?: string | core.$ZodCUID2Params,
): ZodMiniCUID2;
...
export declare function ulid(
  params?: string | core.$ZodULIDParams,
): ZodMiniULID;
...
export declare function ksuid(
  params?: string | core.$ZodKSUIDParams,
): ZodMiniKSUID;
...
export declare function ipv4(
  params?: string | core.$ZodIPv4Params,
): ZodMiniIPv4;
...
export declare function ipv6(
  params?: string | core.$ZodIPv6Params,
): ZodMiniIPv6;
...
export declare function e164(
  params?: string | core.$ZodE164Params,
): ZodMiniE164;
...
export declare function array<T extends SomeType>(
  element: T,
...
export declare function object<
  T extends core.$ZodLooseShape = Record<never, SomeType>,
>(
  shape?: T,
...
export declare function partial<T extends ZodMiniObject>(
  schema: T,
): ZodMiniObject<
  {
...
>;
export declare function required<T extends ZodMiniObject>(
  schema: T,
): ZodMiniObject<
  {
...
export declare function union<const T extends readonly SomeType[]>(
  options: T,
...
export declare function intersection<T extends SomeType, U extends SomeType>(
  left: T,
  right: U,
...
>(items: T, params?: string | core.$ZodTupleParams): ZodMiniTuple<T, null>;
export declare function tuple<
  const T extends readonly [SomeType, ...SomeType[]],
...
export declare function map<Key extends SomeType, Value extends SomeType>(
  keyType: Key,
  valueType: Value,
...
export declare function set<Value extends SomeType>(
  valueType: Value,
...
declare function _enum<T extends util.EnumLike>(
  entries: T,
  params?: string | core.$ZodEnumParams,
): ZodMiniEnum<T>;
...
export declare function file(
  params?: string | core.$ZodFileParams,
): ZodMiniFile;
...
export declare function optional<T extends SomeType>(
  innerType: T,
): ZodMiniOptional<T>;
...
export declare function nullable<T extends SomeType>(
  innerType: T,
): ZodMiniNullable<T>;
export declare function nullish<T extends SomeType>(
  innerType: T,
...
export declare function _default<T extends SomeType>(
  innerType: T,
  defaultValue:
...
export declare function prefault<T extends SomeType>(
  innerType: T,
  defaultValue:
...
export declare function nonoptional<T extends SomeType>(
  innerType: T,
...
export declare function success<T extends SomeType>(
  innerType: T,
): ZodMiniSuccess<T>;
...
declare function _catch<T extends SomeType>(
  innerType: T,
...
export declare function readonly<T extends SomeType>(
  innerType: T,
): ZodMiniReadonly<T>;
...
export declare function promise<T extends SomeType>(
  innerType: T,
): ZodMiniPromise<T>;
...
export declare function custom<O = unknown, I = O>(
  fn?: (data: O) => unknown,
...
declare function _instanceof<T extends typeof Class>(
  cls: T,
