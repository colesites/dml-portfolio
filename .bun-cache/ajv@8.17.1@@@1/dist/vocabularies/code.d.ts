...
export declare function checkReportMissingProp(
  cxt: KeywordCxt,
  prop: string,
): void;
...
export declare function isOwnProperty(
  gen: CodeGen,
  data: Name,
  property: Name | string,
): Code;
export declare function propertyInData(
  gen: CodeGen,
  data: Name,
  property: Name | string,
  ownProperties?: boolean,
): Code;
export declare function noPropertyInData(
  gen: CodeGen,
  data: Name,
  property: Name | string,
  ownProperties?: boolean,
...
export declare function schemaProperties(
  it: SchemaCxt,
  schemaMap: SchemaMap,
): string[];
...
export declare function usePattern(
