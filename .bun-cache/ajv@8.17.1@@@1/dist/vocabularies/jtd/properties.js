  ...
  function isAdditional(key, props, keyword, jtdDiscriminator) {
    ...
    if (props.length > 8) {
      ...
      const propsSchema = (0, util_1.schemaRefOrVal)(
        it,
        parentSchema[keyword],
        keyword,
      );
      additional = (0, codegen_1.not)(
        (0, code_1.isOwnProperty)(gen, propsSchema, key),
      );
      if (jtdDiscriminator !== undefined) {
        additional = (0, codegen_1.and)(
          additional,
          (0, codegen_1._)`${key} !== ${jtdDiscriminator}`,
        );
      }
