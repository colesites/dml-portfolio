...
export declare function coerceAndCheckDataType(
  it: SchemaObjCxt,
  types: JSONType[],
): boolean;
export declare function checkDataType(
  dataType: JSONType,
  data: Name,
  strictNums?: boolean | "log",
  correct?: DataType,
): Code;
export declare function checkDataTypes(
  dataTypes: JSONType[],
  data: Name,
  strictNums?: boolean | "log",
  correct?: DataType,
): Code;
export type TypeError = ErrorObject<
  "type",
  {
    type: string;
  }
