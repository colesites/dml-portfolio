...
function standaloneCode(ajv, refsOrFunc) {
  ...
  return typeof refsOrFunc == "function"
    ...
    : refsOrFunc !== undefined
      ...
      : multiExportsCode(ajv.schemas, (sch) =>
  ...
  function funcExportCode(source) {
    const usedValues = {};
    const n =
      source === null || source === void 0 ? void 0 : source.validateName;
  ...
  function multiExportsCode(schemas, getValidateFunc) {
    ...
    for (const name in schemas) {
      ...
      if (v) {
        ...
        code = (0,
        code_1._)`${code}${_n}${exportSyntax} = ${(_a = v.source) === null || _a === void 0 ? void 0 : _a.validateName};${_n}${vCode}`;
      }
    }
    return `${code}`;
  }
  function validateCode(usedValues, s) {
    ...
    return s.evaluated
      ? (0, code_1._)`${code}${s.validateName}.evaluated = ${s.evaluated};${_n}`
      : code;
    function refValidateCode(n) {
      ...
      if (n.prefix === "validate" && typeof vRef == "function") {
        ...
        const wrapper = (0,
        code_1._)`${def} ${n} = {validate: ${validateName}};`;
        if (usedState(validateName) === scope_1.UsedValueState.Started)
          return wrapper;
        const vCode = validateCode(
          usedValues,
          validate === null || validate === void 0 ? void 0 : validate.source,
        );
