import { _, and, type Code, Name, not } from "../../compile/codegen";
...
const error: KeywordErrorDefinition = {
  ...
  params: ({ params }) =>
    _`{unevaluatedProperty: ${params.unevaluatedProperty}}`,
};
...
const def: CodeKeywordDefinition = {
  ...
  code(cxt) {
    ...
    function unevaluatedStatic(
      evaluatedProps: { [K in string]?: true },
      key: Name,
    ): Code {
      const ps: Code[] = [];
