...
> = AreNegative extends [false, false]
  ...
  : AreNegative extends [true, true]
    ...
    : // When the signs are different we can add the absolute values and then reverse the sign if A < B
      [
          ...TupleOf<NumberAbsolute<A>>,
          ...TupleOf<NumberAbsolute<B>>,
...
type SubtractIfAGreaterThanB<
  A extends number,
  B extends number,
> = TupleOf<A> extends [...TupleOf<B>, ...infer R] ? R["length"] : never; // This is where we always want to end up and do the actual subtraction
