(function () {
  ...
  (t = {}),
    ...
    (t.IPv4.parser = (r) => {
      ...
      if (
        ((n = (r) =>
          "0" === r[0] && "x" !== r[1] ? parseInt(r, 8) : parseInt(r)),
    ...
    (t.IPv4.isValidFourPartDecimal = (r) =>
    ...
    (t.IPv4.subnetMaskFromPrefixLength = function (r) {
      ...
      for (e = [0, 0, 0, 0], n = 0, t = Math.floor(r / 8); n < t; )
        (e[n] = 255), n++;
      return t < 4 && (e[t] = (2 ** (r % 8) - 1) << (8 - (r % 8))), new this(e);
    }),
    ...
    (t.isValid = (r) => t.IPv6.isValid(r) || t.IPv4.isValid(r)),
    (t.parse = (r) => {
