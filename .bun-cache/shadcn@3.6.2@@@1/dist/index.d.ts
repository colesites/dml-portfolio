...
declare function getRegistryItems(
  items: string[],
  options?: {
    config?: Partial<Config>;
    useCache?: boolean;
...
>;
declare function resolveRegistryItems(
  items: string[],
  options?: {
    config?: Partial<Config>;
    useCache?: boolean;
...
declare function getRegistriesConfig(
  cwd: string,
  options?: {
    useCache?: boolean;
  },
...
>;
declare function getRegistryIcons(): Promise<
 ...
 * @deprecated This function is deprecated and will be removed in a future version.
 */
declare function getItemTargetPath(
  config: Config,
...
declare function getPresets(options?: { useCache?: boolean }): Promise<
  {
    style: string;
    baseColor: string;
    iconLibrary: string;
