 ...
 */
declare class ReadableStreamAsyncIterableIteratorImpl<R, TReturn>
 ...
 * @returns
 */
export declare function asyncIterator<R, TReturn>(
  this: ReadableStream<R>,
  { preventCancel }?: ReadableStreamIteratorOptions,
): ReadableStreamAsyncIterableIterator<R, TReturn>;
