...
!((e, t) => {
  ...
  var n = {
    ...
    toArray: (e) => (Array.isArray(e) ? e : t(e) ? [] : [e]),
    repeat: (e, t) => {
      var n,
        i = "";
      for (n = 0; n < t; n += 1) i += e;
    ...
    isNegativeZero: (e) => 0 === e && Number.NEGATIVE_INFINITY === 1 / e,
    extend: (e, t) => {
      var n, i, r, o;
      if (t)
  ...
  var v = new p("tag:yaml.org,2002:bool", {
    ...
    construct: (e) => "true" === e || "True" === e || "TRUE" === e,
    predicate: (e) => "[object Boolean]" === Object.prototype.toString.call(e),
    represent: {
  ...
  var x = new p("tag:yaml.org,2002:int", {
      ...
      represent: {
        binary: (e) =>
          e >= 0 ? "0b" + e.toString(2) : "-0b" + e.toString(2).slice(1),
        octal: (e) =>
          e >= 0 ? "0o" + e.toString(8) : "-0o" + e.toString(8).slice(1),
  ...
  var O = new p("tag:yaml.org,2002:float", {
      kind: "scalar",
      resolve: (e) => null !== e && !(!I.test(e) || "_" === e[e.length - 1]),
      construct: (e) => {
        var t, n;
        return (
  ...
  var E = new p("tag:yaml.org,2002:timestamp", {
    kind: "scalar",
    resolve: (e) => null !== e && (null !== N.exec(e) || null !== F.exec(e)),
    construct: (e) => {
      var t,
        n,
        i,
