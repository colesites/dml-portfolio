...
test("has", (t) => {
  t.plan(1);
  t.teardown(
    mockProperty(Object.prototype, "hasOwnProperty", { delete: true }),
  );
...
test("RegExps", (t) => {
  ...
  t.equal(inspect(/abc/i), "/abc/i", "new RegExp shows properly");
...
test(
  ...
  (t) => {
    ...
    var fake = new Proxy(target, { has: () => false });
    ...
    forEach(["Boolean", "Number", "String", "Symbol", "Date"], (tag) => {
