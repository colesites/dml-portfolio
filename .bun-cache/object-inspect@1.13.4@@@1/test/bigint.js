...
test("bigint", { skip: typeof BigInt === "undefined" }, (t) => {
  ...
  t.test("numericSeparator", (st) => {
    st.equal(
      inspect(BigInt(0), { numericSeparator: false }),
      "0n",
      "0n, numericSeparator false",
    );
    st.equal(
      inspect(BigInt(0), { numericSeparator: true }),
      "0n",
      "0n, numericSeparator true",
    );

    st.equal(
      inspect(BigInt(1234), { numericSeparator: false }),
      "1234n",
      "1234n, numericSeparator false",
    );
    st.equal(
      inspect(BigInt(1234), { numericSeparator: true }),
      "1_234n",
      "1234n, numericSeparator true",
    );
    st.equal(
      inspect(BigInt(-1234), { numericSeparator: false }),
      "-1234n",
