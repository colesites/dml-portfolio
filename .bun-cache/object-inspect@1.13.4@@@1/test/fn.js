...
test("function name", (t) => {
  ...
  t.equal(
    inspect(obj),
    "[ 1, 2, [Function (anonymous)] { toString: [Function: toStr] }, 4 ]",
  );
});
...
test(
  ...
  (t) => {
    ...
    var anon = () => {}; // eslint-disable-line func-style
    ...
    var anon2 = () => {}; // eslint-disable-line func-style
