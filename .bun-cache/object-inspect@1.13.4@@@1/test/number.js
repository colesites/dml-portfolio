...
test("numericSeparator", (t) => {
  ...
  t.test("3 digit numbers", (st) => {
    ...
    for (var i = -999; i < 1000; i += 1) {
      ...
      if (
        actual !== expected ||
        actualSepNo !== expected ||
        actualSepYes !== expected
      ) {
        failed = true;
  ...
  t.equal(
    inspect(1e3, { numericSeparator: false }),
    "1000",
    "1000, numericSeparator false",
  );
  t.equal(
    inspect(1e3, { numericSeparator: true }),
    "1_000",
    "1000, numericSeparator true",
  );
  t.equal(inspect(-1e3), "-1000", "-1000");
  t.equal(
    inspect(-1e3, { numericSeparator: false }),
  ...
  t.equal(
    inspect(1234.5678, { numericSeparator: true }),
    "1_234.567_8",
    "fractional numbers get separators",
  );
  t.equal(
    inspect(1234.56789, { numericSeparator: true }),
    "1_234.567_89",
    "fractional numbers get separators",
  );
  t.equal(
    inspect(1234.567891, { numericSeparator: true }),
    "1_234.567_891",
    "fractional numbers get separators",
  );
