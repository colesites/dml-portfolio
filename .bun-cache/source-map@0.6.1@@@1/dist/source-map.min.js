  ...
  ((e) => {
    ...
    (e, n, r) => {
      ...
      (t.prototype._version = 3),
        ...
        (t.prototype.applySourceMap = function (e, n, r) {
          ...
          var a = new s(),
            u = new s();
          this._mappings.unsortedForEach((n) => {
        ...
        (t.prototype._validateMapping = (e, n, r, t) => {
        ...
        (t.prototype._generateSourcesContent = function (e, n) {
          return e.map(function (e) {
            ...
            return Object.hasOwn(this._sourcesContents, r)
    ...
    (e, n) => {
      ...
      (n.urlParse = t),
        ...
        (n.normalize = i),
        (n.join = s),
        (n.isAbsolute = (e) => "/" === e.charAt(0) || v.test(e)),
        (n.relative = a);
      var C = (() => {
    ...
    (e, n, r) => {
      ...
      var a = r(4),
        ...
        c = r(2),
        g = r(9).quickSort;
      (t.fromSourceMap = (e, n) => o.fromSourceMap(e, n)),
        (t.prototype._version = 3),
        ...
        (t.prototype._charIsMappingSeparator = (e, n) => {
          var r = e.charAt(n);
          return ";" === r || "," === r;
        }),
        (t.prototype._parseMappings = (e, n) => {
        ...
        (o.fromSourceMap = (e, n) => {
          ...
          (r.sourceRoot = e._sourceRoot),
            ...
            (r._absoluteSources = r._sources
              .toArray()
              .map((e) => a.computeSourceURL(r.sourceRoot, e, n)));
          for (
        ...
        (o.prototype._findMapping = (e, n, r, t, o, i) => {
          if (e[r] <= 0)
            throw new TypeError(
        ...
        (o.prototype.hasContentsOfAllSources = function () {
          return (
            ...
            !this.sourcesContent.some((e) => null == e)
          );
        }),
        ...
        (s.prototype.originalPositionFor = function (e) {
          var n = {
            ...
            r = u.search(n, this._sections, (e, n) => {
