...
var SymbolPolyfill =
  typeof Symbol === "function" && typeof Symbol.iterator === "symbol"
    ? Symbol
    : (description) => "Symbol(".concat(description, ")");
...
var _queueMicrotask = (callback) => {
  if (typeof queueMicrotask === "function") {
    ...
    _queueMicrotask = (cb) => PerformPromiseThen(resolvedPromise_1, cb);
  }
...
var MathTrunc = Math.trunc || ((v) => (v < 0 ? Math.ceil(v) : Math.floor(v)));
...
function assertRequiredArgument(x, position, context) {
  if (x === undefined) {
    throw new TypeError(
      "Parameter ".concat(position, " is required in '").concat(context, "'."),
    );
  }
}
function assertRequiredField(x, field, context) {
  if (x === undefined) {
    throw new TypeError(
      "".concat(field, " is required in '").concat(context, "'."),
    );
  }
}
...
function convertUnsignedLongLongWithEnforceRange(value, context) {
  ...
  if (x < lowerBound || x > upperBound) {
    throw new TypeError(
      ""
        .concat(context, " is outside the accepted range of ")
        .concat(lowerBound, " to ")
        .concat(upperBound, ", inclusive"),
    );
  }
...
function CreateAsyncFromSyncIterator(syncIteratorRecord) {
  ...
  var syncIterable =
    ((_a = {}),
    (_a[SymbolPolyfill.iterator] = () => syncIteratorRecord.iterator),
    _a);
...
var SymbolAsyncIterator =
  (_c =
    (_a$1 = SymbolPolyfill.asyncIterator) !== null && _a$1 !== void 0
      ? _a$1
      : (_b = SymbolPolyfill.for) === null || _b === void 0
        ? void 0
        : _b.call(SymbolPolyfill, "Symbol.asyncIterator")) !== null &&
  _c !== void 0
    ? _c
    : "@@asyncIterator";
...
var ReadableStreamAsyncIteratorImpl = /** @class */ (() => {
  ...
  ReadableStreamAsyncIteratorImpl.prototype._returnSteps = function (value) {
    ...
    if (!this._preventCancel) {
      ...
      ReadableStreamReaderGenericRelease(reader);
      return transformPromiseWith(result, () => ({ value: value, done: true }));
    }
    ReadableStreamReaderGenericRelease(reader);
    ...
    mode:
      mode === undefined
        ...
        : convertReadableStreamReaderMode(
            mode,
            "".concat(context, " has member 'mode' that"),
          ),
  };
}
...
function convertByobReadOptions(options, context) {
  ...
  assertDictionary(options, context);
  var min =
    (_a = options === null || options === void 0 ? void 0 : options.min) !==
      null && _a !== void 0
      ? _a
      : 1;
  return {
    min: convertUnsignedLongLongWithEnforceRange(
      min,
      "".concat(context, " has member 'min' that"),
    ),
  };
}
    ...
    size:
      size === undefined
        ...
        : convertQueuingStrategySize(
            size,
            "".concat(context, " has member 'size' that"),
          ),
  };
}
    ...
    abort:
      abort === undefined
        ...
        : convertUnderlyingSinkAbortCallback(
            abort,
            original,
            "".concat(context, " has member 'abort' that"),
          ),
    close:
      close === undefined
        ? undefined
        : convertUnderlyingSinkCloseCallback(
            close,
            original,
            "".concat(context, " has member 'close' that"),
          ),
    start:
      start === undefined
        ? undefined
        : convertUnderlyingSinkStartCallback(
            start,
            original,
            "".concat(context, " has member 'start' that"),
          ),
    write:
      write === undefined
        ? undefined
        : convertUnderlyingSinkWriteCallback(
            write,
            original,
            "".concat(context, " has member 'write' that"),
          ),
    type: type,
  };
}
...
function getFromGlobal() {
  var ctor =
    globals === null || globals === void 0 ? void 0 : globals.DOMException;
  ...
  return newPromise((resolve, reject) => {
    ...
    function pipeStep() {
      ...
      return PerformPromiseThen(writer._readyPromise, () =>
        newPromise((resolveRead, rejectRead) => {
    ...
    if (WritableStreamCloseQueuedOrInFlight(dest) || dest._state === "closed") {
      ...
      if (!preventCancel) {
        shutdownWithAction(
          () => ReadableStreamCancel(source, destClosed_1),
          true,
          destClosed_1,
        );
      } else {
...
var ReadableStreamDefaultController = /** @class */ (() => {
  ...
  /** @internal */
  ReadableStreamDefaultController.prototype[ReleaseSteps] = () => {
    // Do nothing.
  };
...
function ReadableByteStreamTee(stream) {
  ...
  function pull1Algorithm() {
    ...
    reading = true;
    var byobRequest = ReadableByteStreamControllerGetBYOBRequest(
      branch1._readableStreamController,
    );
    if (byobRequest === null) {
    ...
    autoAllocateChunkSize:
      autoAllocateChunkSize === undefined
        ...
        : convertUnsignedLongLongWithEnforceRange(
            autoAllocateChunkSize,
            "".concat(context, " has member 'autoAllocateChunkSize' that"),
          ),
    cancel:
      cancel === undefined
        ? undefined
        : convertUnderlyingSourceCancelCallback(
            cancel,
            original,
            "".concat(context, " has member 'cancel' that"),
          ),
    pull:
      pull === undefined
        ? undefined
        : convertUnderlyingSourcePullCallback(
            pull,
            original,
            "".concat(context, " has member 'pull' that"),
          ),
    start:
      start === undefined
        ? undefined
    ...
    type:
      type === undefined
        ...
        : convertReadableStreamType(
            type,
            "".concat(context, " has member 'type' that"),
          ),
  };
}
...
function convertReadableWritablePair(pair, context) {
  ...
  assertReadableStream(
    readable,
    "".concat(context, " has member 'readable' that"),
  );
  var writable = pair === null || pair === void 0 ? void 0 : pair.writable;
  assertRequiredField(writable, "writable", "ReadableWritablePair");
  assertWritableStream(
    writable,
    "".concat(context, " has member 'writable' that"),
  );
...
var ReadableStream = /** @class */ (() => {
   ...
   */
  ReadableStream.from = (asyncIterable) => ReadableStreamFrom(asyncIterable);
...
var byteLengthSizeFunction = (chunk) => chunk.byteLength;
    ...
    flush:
      flush === undefined
        ...
        : convertTransformerFlushCallback(
            flush,
            original,
            "".concat(context, " has member 'flush' that"),
          ),
    ...
    transform:
      transform === undefined
        ...
        : convertTransformerTransformCallback(
            transform,
            original,
            "".concat(context, " has member 'transform' that"),
          ),
