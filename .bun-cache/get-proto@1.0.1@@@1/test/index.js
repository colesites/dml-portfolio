...
test("getProto", (t) => {
  ...
  t.test("can get", { skip: !getProto }, (st) => {
    if (getProto) {
      // TS doesn't understand tape's skip
      var proto = { b: 2 };
      st.equal(
        getProto(proto),
        Object.prototype,
      ...
      st.test("nullish value", (s2t) => {
        ...
        // @ts-expect-error
        s2t["throws"](() => getProto(null), TypeError, "null is not an object");
        s2t.end();
      });
  ...
  t.test("can not get", { skip: !!getProto }, (st) => {
