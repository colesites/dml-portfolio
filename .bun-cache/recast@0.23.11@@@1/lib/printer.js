...
var Printer = function Printer(config) {
  ...
  function print(path, options) {
    ...
    if (options.includeComments) {
      return (0, comments_1.printComments)(
        path,
  ...
  this.printGenerically = (ast) => {
    if (!ast) {
      return emptyPrintResult;
    }
    // Print the entire AST generically.
    function printGenerically(path) {
      return (0, comments_1.printComments)(path, (path) =>
        genericPrint(
          path,
          config,
          {
  ...
  switch (n.type) {
    ...
    case "ImportDeclaration": {
      ...
      if (n.specifiers && n.specifiers.length > 0) {
        ...
        unbracedSpecifiers_1.forEach((lines, i) => {
          if (i > 0) {
            parts.push(", ");
          }
          parts.push(lines);
      ...
      if (n.directives) {
        path.each((childPath) => {
          parts.push(
            ...
            n.directives.length > 1 || !naked_1.isEmpty() ? "\n" : "",
          );
        }, "directives");
      }
    ...
    case "ReturnStatement": {
      ...
      if (n.argument) {
        var argIsJsxElement =
          ((_a = namedTypes.JSXElement) === null || _a === void 0
            ? void 0
            : _a.check(n.argument)) ||
          ((_b = namedTypes.JSXFragment) === null || _b === void 0
            ? void 0
            : _b.check(n.argument));
        ...
        if (
          ...
          if (
            argIsJsxElement &&
            ((_c = n.argument.extra) === null || _c === void 0
              ? void 0
              : _c.parenthesized)
          ) {
    ...
    case "RegExpLiteral": // Babel 6 Literal split
      return (0, lines_1.fromString)(
        getPossibleRaw(n) || "/".concat(n.pattern, "/").concat(n.flags || ""),
        options,
      );
    ...
    case "VariableDeclaration": {
      ...
      parts.push(n.kind, " ");
      var maxLen_1 = 0;
      var printed = path.map((childPath) => {
        var lines = print(childPath);
    ...
    case "JSXFragment": {
      ...
      var childLines = (0, lines_1.concat)(
        path.map((childPath) => {
    ...
    case "JSXOpeningElement": {
      ...
      if (needLineWrap) {
        attrParts_1.forEach((part, i) => {
          if (part === " ") {
            (0, tiny_invariant_1.default)(i % 2 === 0);
            attrParts_1[i] = "\n";
          }
        });
        attrLines = (0, lines_1.concat)(attrParts_1).indentTail(
          options.tabWidth,
        );
      }
    ...
    case "ClassAccessorProperty": {
      parts.push.apply(
        ...
        tslib_1.__spreadArray(
          tslib_1.__spreadArray([], printClassMemberModifiers(n), false),
          ["accessor "],
          false,
        ),
      );
    ...
    case "DeclareClass":
      ...
      if (n.extends && n.extends.length > 0) {
        ...
        parts.push(
          " extends ",
          (0, lines_1.fromString)(", ").join(path.map(print, "extends")),
        );
      }
      if (n["implements"] && n["implements"].length > 0) {
        parts.push(
          " implements ",
          (0, lines_1.fromString)(", ").join(path.map(print, "implements")),
        );
      }
      parts.push(" ", path.call(print, "body"));
    ...
    case "Block": // Esprima block comment.
      return (0, lines_1.concat)([
        "/*",
        (0, lines_1.fromString)(n.value, options),
        "*/",
      ]);
...
function printExportDeclaration(path, options, print) {
  ...
  if (decl.declaration) {
    ...
    if (
      ...
      unbracedSpecifiers_2.forEach((lines, i) => {
        if (i > 0) {
          parts.push(", ");
        }
        parts.push(lines);
      ...
      parts.push(
        shouldPrintSpaces ? "{ " : "{",
        (0, lines_1.fromString)(", ").join(path.map(print, "specifiers")),
        shouldPrintSpaces ? " }" : "}",
      );
    }
    if (decl.source) {
...
function printFlowDeclaration(path, parts) {
  ...
  if (parentExportDecl) {
    (0, tiny_invariant_1.default)(
      parentExportDecl.type === "DeclareExportDeclaration",
    );
  } else {
