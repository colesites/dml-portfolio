...
const returnWithoutSpecialBehavior = (tag, children, props) =>
  (0, import_html.raw)(
    new import_base.JSXNode(
      tag,
      props,
...
const documentMetadataTag = (tag, children, props, sort) => {
  ...
  const string = new import_base.JSXNode(
    tag,
    restProps,
    (0, import_children.toArray)(children || []),
  ).toString();
...
const script = ({ children, ...props }) => {
  ...
  if (
    ...
    (nameSpaceContext &&
      (0, import_context.useContext)(nameSpaceContext) === "head")
  ) {
...
const form = (props) => {
  if (typeof props.action === "function") {
    props.action =
      import_constants.PERMALINK in props.action
        ? props.action[import_constants.PERMALINK]
        : void 0;
  }
...
const formActionableElement = (tag, props) => {
  if (typeof props.formAction === "function") {
    props.formAction =
      import_constants.PERMALINK in props.formAction
        ? props.formAction[import_constants.PERMALINK]
        : void 0;
  }
