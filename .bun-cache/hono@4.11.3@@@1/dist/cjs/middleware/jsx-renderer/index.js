...
const createRenderer = (c, Layout, component, options) => (children, props) => {
  ...
  const currentLayout = component
    ...
    : children;
  const body = import_html.html`${(0, import_html.raw)(docType)}${(0,
  import_jsx.jsx)(RequestContext.Provider, { value: c }, currentLayout)}`;
  if (options?.stream) {
...
const jsxRenderer = (component, options) =>
