...
> {
  ...
  >(
    ...
    BasePath,
    Ps extends [...string[], infer LastPath extends string]
      ? MergePath<BasePath, LastPath>
      : never
  >;
}
type ToSchemaOutput<
...
> = {
  [P in keyof OrigSchema as MergePath<SubPath, P & string>]: [
    OrigSchema[P],
  ] extends [Record<string, Endpoint>]
    ? {
...
type MergeMiddlewareResponse<T> = T extends (
  c: any,
  next: any,
) => Promise<infer R>
...
export type ExtractHandlerResponse<T> = T extends (
  c: any,
  next: any,
) => Promise<infer R>
  ? Exclude<R, void> extends never
  ...
  : T extends (c: any, next: any) => infer R
    ? R extends Response | TypedResponse<any, any, any>
      ...
      : never
    : never;
type ProcessHead<T> = IfAnyThenEmptyObject<
  T extends Env ? (Env extends T ? {} : T) : T
>;
