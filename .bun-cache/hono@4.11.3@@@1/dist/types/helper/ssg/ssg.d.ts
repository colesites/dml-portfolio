...
export declare const combineBeforeRequestHooks: (
  hooks: BeforeRequestHook | BeforeRequestHook[],
) => BeforeRequestHook;
export declare const combineAfterResponseHooks: (
  hooks: AfterResponseHook | AfterResponseHook[],
) => AfterResponseHook;
export declare const combineAfterGenerateHooks: (
 ...
 * The API might be changed.
 */
export declare const fetchRoutesContent: <
  E extends Env = Env,
  S extends Schema = {},
...
>(
  ...
  >
>;
export declare const saveContentToFile: (
  data: Promise<
    | {
        routePath: string;
        content: string | ArrayBuffer;
 ...
 * The API might be changed.
 */
export type ToSSGAdaptorInterface<
  E extends Env = Env,
  S extends Schema = {},
  BasePath extends string = "/",
