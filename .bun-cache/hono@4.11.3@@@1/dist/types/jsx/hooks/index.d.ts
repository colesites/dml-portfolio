...
export declare const useReducer: <T, A>(
  reducer: (state: T, action: A) => T,
  initialArg: T,
  init?: (initialState: T) => T,
) => [T, (action: A) => void];
export declare const useEffect: (
  effect: () => void | (() => void),
  deps?: readonly unknown[],
) => void;
export declare const useLayoutEffect: (
  effect: () => void | (() => void),
  deps?: readonly unknown[],
) => void;
export declare const useInsertionEffect: (
  effect: () => void | (() => void),
  deps?: readonly unknown[],
) => void;
...
export declare const useMemo: <T>(
  factory: () => T,
  deps: readonly unknown[],
) => T;
export declare const useId: () => string;
export declare const useDebugValue: (
  _value: unknown,
...
export declare const useImperativeHandle: <T>(
  ref: RefObject<T>,
  createHandle: () => T,
  deps: readonly unknown[],
) => void;
export declare const useSyncExternalStore: <T>(
