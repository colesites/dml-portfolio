...
declare const cloneElement: <T extends JSXNode | JSX.Element>(
  element: T,
  props: Props,
  ...children: Child[]
) => T;
declare const memo: <T>(
  component: FC<T>,
...
declare const _default: {
  ...
  forwardRef: <T, P = {}>(
    Component: (props: P, ref?: import("..").RefObject<T>) => JSX.Element,
  ) => (
    props: P & {
  ...
  cloneElement: <T extends JSXNode | JSX.Element>(
    element: T,
    props: Props,
    ...children: Child[]
  ) => T;
