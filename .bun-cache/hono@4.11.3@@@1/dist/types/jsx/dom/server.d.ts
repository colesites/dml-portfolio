 ...
 */
declare const renderToReadableStream: (
  element: Child,
...
declare const _default: {
  ...
  version: {
    ...
    createElement: (
      tag: string | ((props: import("../base").Props) => import("..").JSXNode),
      props: import("../base").Props | null,
      ...children: Child[]
    ) => import("..").JSXNode;
    cloneElement: <
      T extends import("..").JSXNode | import("./jsx-dev-runtime").JSX.Element,
    >(
      element: T,
