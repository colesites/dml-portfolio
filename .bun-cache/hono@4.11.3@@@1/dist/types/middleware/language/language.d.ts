 ...
 */
export declare const normalizeLanguage: (
 ...
 */
export declare const detectFromQuery: (
  c: Context,
  options: DetectorOptions,
) => string | undefined;
/**
 ...
 */
export declare const detectFromCookie: (
  c: Context,
  options: DetectorOptions,
) => string | undefined;
/**
 ...
 */
export declare function detectFromHeader(
  c: Context,
  options: DetectorOptions,
): string | undefined;
/**
 ...
 */
export declare function detectFromPath(
  c: Context,
  options: DetectorOptions,
): string | undefined;
/**
...
export declare const languageDetector: (
  userOptions: Partial<DetectorOptions>,
) => MiddlewareHandler;
