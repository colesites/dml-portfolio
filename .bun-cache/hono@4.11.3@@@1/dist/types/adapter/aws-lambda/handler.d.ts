...
export declare const streamHandle: <
  E extends Env = Env,
  S extends Schema = {},
...
export declare const getProcessor: (
  event: LambdaEvent,
 ...
 */
export declare const defaultIsContentTypeBinary: (
  contentType: string,
) => boolean;
export declare const isContentEncodingBinary: (
