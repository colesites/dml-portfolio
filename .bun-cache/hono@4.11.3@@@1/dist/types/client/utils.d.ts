...
export declare const replaceUrlParam: (
  urlString: string,
  params: Record<string, string | undefined>,
) => string;
export declare const buildSearchParams: (
  query: Record<string, string | string[]>,
) => URLSearchParams;
export declare const replaceUrlProtocol: (
  urlString: string,
  protocol: "ws" | "http",
) => string;
 ...
 */
export declare function parseResponse<T extends ClientResponse<any>>(
