...
exports.xchacha20poly1305 =
  exports.chacha20poly1305 =
  exports._poly1305_aead =
  exports.xsalsa20poly1305 =
  exports.chacha12 =
  exports.chacha8 =
  exports.xchacha20 =
  exports.chacha20 =
  exports.chacha20orig =
  exports.xsalsa20 =
  exports.salsa20 =
    void 0;
...
function bytesToNumberLE(bytes) {
  ...
  return (0, utils_ts_1.hexToNumber)(
    (0, utils_ts_1.bytesToHex)(Uint8Array.from(bytes).reverse()),
  );
}
...
function computeTag(fn, key, nonce, ciphertext, AAD) {
  ...
  if (leftover > 0) res.push(new Uint8Array(16 - leftover));
  res.push(
    (0, utils_ts_1.u64Lengths)(ciphertext.length, AAD ? AAD.length : 0, true),
  );
  const authKey = fn(key, nonce, new Uint8Array(32));
  return poly1305((0, utils_ts_1.concatBytes)(...res), authKey);
}
/** xsalsa20-poly1305 eXtended-nonce (24 bytes) salsa. */
exports.xsalsa20poly1305 = (0, utils_ts_1.wrapCipher)(
  { blockSize: 64, nonceLength: 24, tagLength: 16 },
  function xsalsapoly(key, nonce) {
    return {
      encrypt(plaintext) {
