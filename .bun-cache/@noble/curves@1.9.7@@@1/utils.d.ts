...
export declare function _abytes2(
  value: Uint8Array,
  length?: number,
  title?: string,
): Uint8Array;
...
export declare function numberToBytesLE(
  n: number | bigint,
  len: number,
): Uint8Array;
 ...
 * @returns
 */
export declare function ensureBytes(
  title: string,
  hex: Hex,
 ...
 */
export declare function aInRange(
  title: string,
  n: bigint,
  min: bigint,
  max: bigint,
 ...
 */
export declare function createHmacDrbg<T>(
  hashLen: number,
  qByteLen: number,
...
export declare function validateObject<T extends Record<string, any>>(
  object: T,
  validators: ValMap<T>,
  optValidators?: ValMap<T>,
): T;
export declare function isHash(val: CHash): boolean;
export declare function _validateObject(
 ...
 */
export declare function memoized<T extends object, R, O extends any[]>(
  fn: (arg: T, ...args: O) => R,
): (arg: T, ...args: O) => R;
