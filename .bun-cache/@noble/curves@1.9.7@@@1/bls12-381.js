...
const { G2psi, G2psi2 } = (0, tower_ts_1.psiFrobenius)(
  Fp,
  Fp2,
  Fp2.div(Fp2.ONE, Fp2.NONRESIDUE),
); // 1/(u+1)
/**
  ...
  if (isComp) {
    ...
    if (is0) {
      return (0, utils_ts_1.concatBytes)(
        Uint8Array.of(0x40),
        new Uint8Array(2 * L - 1),
      );
    } else {
      return (0, utils_ts_1.concatBytes)(
        (0, utils_ts_1.numberToBytesBE)(x, L),
        (0, utils_ts_1.numberToBytesBE)(y, L),
      );
    }
  }
}
...
function signatureG1FromBytes(hex) {
  const { infinity, sort, value } = parseMask(
    (0, utils_ts_1.ensureBytes)("signatureHex", hex, 48),
  );
  const P = Fp.ORDER;
...
function pointG2ToBytes(_c, point, isComp) {
  ...
  if (isComp) {
    if (is0)
      return (0, utils_ts_1.concatBytes)(
        COMPZERO,
        (0, utils_ts_1.numberToBytesBE)(_0n, L),
      );
    const flag = Boolean(y.c1 === _0n ? (y.c0 * _2n) / P : (y.c1 * _2n) / P);
    return (0, utils_ts_1.concatBytes)(
      setMask((0, utils_ts_1.numberToBytesBE)(x.c1, L), {
        compressed: true,
        sort: flag,
      }),
    ...
    if (is0)
      return (0, utils_ts_1.concatBytes)(
        Uint8Array.of(0x40),
        new Uint8Array(4 * L - 1),
      );
    const { re: x0, im: x1 } = Fp2.reim(x);
    const { re: y0, im: y1 } = Fp2.reim(y);
    return (0, utils_ts_1.concatBytes)(
      (0, utils_ts_1.numberToBytesBE)(x1, L),
      (0, utils_ts_1.numberToBytesBE)(x0, L),
      (0, utils_ts_1.numberToBytesBE)(y1, L),
      (0, utils_ts_1.numberToBytesBE)(y0, L),
    );
  }
}
function signatureG2ToBytes(point) {
  ...
  const z2 = x0;
  return (0, utils_ts_1.concatBytes)(
    setMask((0, utils_ts_1.numberToBytesBE)(x1, L), { sort, compressed: true }),
...
function pointG2FromBytes(bytes) {
  ...
  const slc = (b, from, to) =>
    (0, utils_ts_1.bytesToNumberBE)(b.slice(from, to));
  if (value.length === 96 && compressed) {
    ...
    const Y_bit =
      y.c1 === _0n ? (y.c0 * _2n) / P : (y.c1 * _2n) / P ? _1n : _0n;
...
function signatureG2FromBytes(hex) {
  ...
  const { infinity, sort, value } = parseMask(
    (0, utils_ts_1.ensureBytes)("signatureHex", hex),
  );
  const Point = exports.bls12_381.G2.Point;
  const half = value.length / 2;
  if (half !== 48 && half !== 96)
    throw new Error(
      "invalid compressed signature length, expected 96/192 bytes",
    );
...
exports.bls12_381 = (0, bls_ts_1.bls)({
  ...
  G2: {
    ...
    clearCofactor: (c, P) => {
      const x = BLS_X;
      const t1 = P.multiplyUnsafe(x).negate(); // [-x]P
...
const isogenyMapG2 = (0, hash_to_curve_ts_1.isogenyMap)(
  Fp2,
  [
    // xNum
    [
...
const isogenyMapG1 = (0, hash_to_curve_ts_1.isogenyMap)(
  Fp,
  [
    // xNum
    [
