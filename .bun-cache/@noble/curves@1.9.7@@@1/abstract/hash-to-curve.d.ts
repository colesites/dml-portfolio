 ...
 */
export declare function expand_message_xmd(
  msg: Uint8Array,
  DST: UnicodeOrBytes,
  lenInBytes: number,
  H: CHash,
 ...
 */
export declare function expand_message_xof(
  msg: Uint8Array,
  DST: UnicodeOrBytes,
  lenInBytes: number,
  k: number,
 ...
 */
export declare function hash_to_field(
  msg: Uint8Array,
  count: number,
  options: H2COpts,
): bigint[][];
...
export declare function isogenyMap<T, F extends IField<T>>(
  field: F,
  map: XYRatio<T>,
): XY<T>;
...
export declare function createHasher<T>(
