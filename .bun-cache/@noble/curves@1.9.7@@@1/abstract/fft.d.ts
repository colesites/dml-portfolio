 ...
 */
export declare function bitReversalInplace<T extends MutableArrayLike<any>>(
  values: T,
): T;
...
export declare function rootsOfUnity(
  field: IField<bigint>,
  generator?: bigint,
): RootsOfUnity;
 ...
 */
export declare const FFTCore: <T, R>(
  F: FFTOpts<T, R>,
 ...
 */
export declare function poly<T>(
  field: IField<T>,
  roots: RootsOfUnity,
  create?: undefined,
  fft?: FFTMethods<T>,
...
export declare function poly<T, P extends Polynomial<T>>(
  field: IField<T>,
  roots: RootsOfUnity,
  create: CreatePolyFn<P, T>,
  fft?: FFTMethods<T>,
