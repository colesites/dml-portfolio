...
export declare function negateCt<
  T extends {
    negate: () => T;
  },
 ...
 */
export declare function normalizeZ<
 ...
 */
export declare function mulEndoUnsafe<
  P extends CurvePoint<any, P>,
  PC extends CurvePointCons<P>,
>(
  Point: PC,
...
/** @deprecated */
export declare function validateBasic<FP, T>(
...
export declare function _createCurveFields<T>(
