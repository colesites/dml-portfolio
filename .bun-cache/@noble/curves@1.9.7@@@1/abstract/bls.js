...
function createBlsSig(blsPairing, PubCurve, SigCurve, SignatureCoder, isSigG1) {
  ...
  return {
    ...
    getPublicKey(secretKey) {
      ...
      const sec = (0, weierstrass_ts_1._normFnElement)(
        PubCurve.Point.Fn,
        secretKey,
      );
...
function bls(CURVE) {
  ...
  const G1 = Object.assign(
    G1_,
    (0, hash_to_curve_ts_1.createHasher)(G1_.Point, CURVE.G1.mapToCurve, {
      ...CURVE.htfDefaults,
  ...
  const G2 = Object.assign(
    G2_,
    (0, hash_to_curve_ts_1.createHasher)(G2_.Point, CURVE.G2.mapToCurve, {
      ...CURVE.htfDefaults,
  ...
  function normP1Hash(point, htfOpts) {
    return point instanceof G1.Point
      ? point
      : shortSignatures.hash(
          (0, utils_ts_1.ensureBytes)("point", point),
          htfOpts?.DST,
        );
  }
