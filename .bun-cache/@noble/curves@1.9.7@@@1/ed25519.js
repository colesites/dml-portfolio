...
exports.hash_to_ristretto255 =
  exports.hashToRistretto255 =
...
const ELL2_C1_EDWARDS = /* @__PURE__ */ (() =>
  (0, modular_ts_1.FpSqrtEven)(Fp, Fp.neg(BigInt(486664))))(); // sgn0(c1) MUST equal 0
...
const bytes255ToNumberLE = (bytes) =>
  exports.ed25519.Point.Fp.create(
...
function calcElligatorRistrettoMap(r0) {
  ...
  return new exports.ed25519.Point(
    mod(W0 * W3),
    mod(W2 * W1),
    mod(W1 * W3),
    mod(W0 * W2),
...
_RistrettoPoint.BASE = /* @__PURE__ */ (() =>
  new _RistrettoPoint(exports.ed25519.Point.BASE))();
// prettier-ignore
_RistrettoPoint.ZERO = /* @__PURE__ */ (() =>
  new _RistrettoPoint(exports.ed25519.Point.ZERO))();
// prettier-ignore
...
function edwardsToMontgomeryPub(edwardsPub) {
  return exports.ed25519.utils.toMontgomery(
...
function edwardsToMontgomeryPriv(edwardsPriv) {
  return exports.ed25519.utils.toMontgomerySecret(
...
/** @deprecated use `import { ristretto255_hasher } from '@noble/curves/ed25519.js';` */
exports.hash_to_ristretto255 = (() =>
  exports.ristretto255_hasher.hashToCurve)();
