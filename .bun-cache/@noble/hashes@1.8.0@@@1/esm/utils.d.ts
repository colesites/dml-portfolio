...
export declare function asyncLoop(
  iters: number,
  tick: number,
  cb: (i: number) => void,
): Promise<void>;
...
export declare function createHasher<T extends Hash<T>>(
  hashCons: () => Hash<T>,
): {
...
export declare function createOptHasher<H extends Hash<H>, T extends Object>(
...
export declare function createXOFer<H extends HashXOF<H>, T extends Object>(
