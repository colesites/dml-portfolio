...
export const blake224 = /* @__PURE__ */ createOptHasher(
  (opts) => new BLAKE224(opts),
);
/** blake1-256 hash function */
export const blake256 = /* @__PURE__ */ createOptHasher(
  (opts) => new BLAKE256(opts),
);
/** blake1-384 hash function */
export const blake384 = /* @__PURE__ */ createOptHasher(
  (opts) => new BLAKE384(opts),
);
/** blake1-512 hash function */
export const blake512 = /* @__PURE__ */ createOptHasher(
