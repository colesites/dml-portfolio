...
exports.keccakprg =
  ...
  exports.m14 =
  exports.k12 =
  exports.KangarooTwelve =
  exports.turboshake256 =
  exports.turboshake128 =
  exports.parallelhash256xof =
  exports.parallelhash128xof =
  exports.parallelhash256 =
  exports.parallelhash128 =
  exports.ParallelHash =
  exports.tuplehash256xof =
  exports.tuplehash128xof =
  exports.tuplehash256 =
  exports.tuplehash128 =
  exports.TupleHash =
  exports.kmac256xof =
  exports.kmac128xof =
  exports.kmac256 =
...
const gencShake = (suffix, blockLen, outputLen) =>
  (0, utils_ts_1.createXOFer)((opts = {}) =>
    cshakePers(
      new sha3_ts_1.Keccak(blockLen, suffix, chooseLen(opts, outputLen), true),
      opts,
    ),
  );
...
exports.parallelhash128xof = (() =>
  genPrl(168, 128 / 8, exports.cshake128, true))();
/** 256-bit ParallelHash. In JS, it is not parallel. */
exports.parallelhash256xof = (() =>
  genPrl(136, 256 / 8, exports.cshake256, true))();
const genTurboshake = (blockLen, outputLen) =>
  (0, utils_ts_1.createXOFer)((opts = {}) => {
  ...
  update(data) {
    ...
    for (let pos = 0, len = data.length; pos < len; ) {
      if (this.chunkPos == chunkLen) {
        ...
        this.leafHash = new sha3_ts_1.Keccak(
          blockLen,
          0x0b,
          leafLen,
          false,
