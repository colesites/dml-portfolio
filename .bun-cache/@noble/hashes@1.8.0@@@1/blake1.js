...
class BLAKE1 extends utils_ts_1.Hash {
  ...
  update(data) {
    ...
    for (let pos = 0; pos < len; ) {
      ...
      if (take === blockLen) {
        if (!dataView) dataView = (0, utils_ts_1.createView)(data);
  ...
  compress(view, offset, withLength = true) {
    ...
    for (let i = 0, k = 0, j = 0; i < 14; i++) {
      ({
        ...
        v08,
        v12,
        BLAKE256_W[_blake_ts_1.BSIGMA[k++]] ^ TBL256[j++],
      ));
      ({
        a: v00,
        b: v04,
...
exports.blake224 = (0, utils_ts_1.createOptHasher)(
  (opts) => new BLAKE224(opts),
);
/** blake1-256 hash function */
exports.blake256 = (0, utils_ts_1.createOptHasher)(
  (opts) => new BLAKE256(opts),
);
/** blake1-384 hash function */
exports.blake384 = (0, utils_ts_1.createOptHasher)(
  (opts) => new BLAKE384(opts),
);
/** blake1-512 hash function */
exports.blake512 = (0, utils_ts_1.createOptHasher)(
