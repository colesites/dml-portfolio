...
exports.argon2idAsync =
  exports.argon2iAsync =
  exports.argon2dAsync =
  exports.argon2id =
  exports.argon2i =
  exports.argon2d =
    void 0;
...
function G(a, b, c, d) {
  ...
  ({ Dh, Dl } = {
    Dh: (0, _u64_ts_1.rotr32H)(Dh, Dl),
    Dl: (0, _u64_ts_1.rotr32L)(Dh, Dl),
  });
  ({ h: Ch, l: Cl } = blamka(Ch, Cl, Dh, Dl));
  ({ Bh, Bl } = { Bh: Bh ^ Ch, Bl: Bl ^ Cl });
  ({ Bh, Bl } = {
    Bh: (0, _u64_ts_1.rotrSH)(Bh, Bl, 24),
    Bl: (0, _u64_ts_1.rotrSL)(Bh, Bl, 24),
  });
  ({ h: Ah, l: Al } = blamka(Ah, Al, Bh, Bl));
  ({ Dh, Dl } = { Dh: Dh ^ Ah, Dl: Dl ^ Al });
  ({ Dh, Dl } = {
    Dh: (0, _u64_ts_1.rotrSH)(Dh, Dl, 16),
    Dl: (0, _u64_ts_1.rotrSL)(Dh, Dl, 16),
  });
  ({ h: Ch, l: Cl } = blamka(Ch, Cl, Dh, Dl));
  ({ Bh, Bl } = { Bh: Bh ^ Ch, Bl: Bl ^ Cl });
  ({ Bh, Bl } = {
    Bh: (0, _u64_ts_1.rotrBH)(Bh, Bl, 63),
    Bl: (0, _u64_ts_1.rotrBL)(Bh, Bl, 63),
  });
...
function Hp(A, dkLen) {
  ...
  const V = blake2_ts_1.blake2b.create({}).update(T8).update(A8).digest();
  let pos = 0;
  // First block
...
function argon2Init(password, salt, type, opts) {
  ...
  if (!isU32(maxmem) || memUsed > maxmem)
    throw new Error(
      "mem should be less than 2**32, got: maxmem=" +
        maxmem +
        ", memused=" +
        memUsed,
    );
...
function argon2(type, password, salt, opts) {
  const { mP, p, t, version, B, laneLen, lanes, segmentLen, dkLen, perBlock } =
...
const argon2idAsync = (password, salt, opts) =>
