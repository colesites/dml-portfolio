...
const { equal: fastUriEqual, parse: fastUriParse } = fastUri;
...
benchFastUri.add("equal string with string", () => {
  fastUriEqual(stringA, stringA);
});

benchFastUri.add("equal component with component", () => {
  fastUriEqual(componentA, componentA);
});

benchFastUri.add("equal component with string", () => {
  fastUriEqual(componentA, stringA);
});

benchFastUri.add("equal string with component", () => {
  fastUriEqual(stringA, componentA);
});

benchFastUri.add("not equal string with string", () => {
  fastUriEqual(stringA, stringB);
});

benchFastUri.add("not equal component with component", () => {
  fastUriEqual(componentA, componentB);
});

benchFastUri.add("not equal component with string", () => {
  fastUriEqual(componentA, stringB);
});

benchFastUri.add("not equal string with component", () => {
