...
export interface Visitor<M = {}> {
  ...
  visitStaticBlock?(
    this: Context & M,
    path: NodePath<namedTypes.StaticBlock>,
  ): any;
  ...
  visitImportAttribute?(
    this: Context & M,
    path: NodePath<namedTypes.ImportAttribute>,
  ): any;
  visitRecordExpression?(
    this: Context & M,
    path: NodePath<namedTypes.RecordExpression>,
  ): any;
  visitObjectMethod?(
    this: Context & M,
  ...
  visitTupleExpression?(
    this: Context & M,
    path: NodePath<namedTypes.TupleExpression>,
  ): any;
  visitModuleExpression?(
    this: Context & M,
    path: NodePath<namedTypes.ModuleExpression>,
  ): any;
  visitJSXAttribute?(
    this: Context & M,
  ...
  visitIndexedAccessType?(
    this: Context & M,
    path: NodePath<namedTypes.IndexedAccessType>,
  ): any;
  visitOptionalIndexedAccessType?(
    this: Context & M,
    path: NodePath<namedTypes.OptionalIndexedAccessType>,
  ): any;
  ...
  visitDecimalLiteral?(
    this: Context & M,
    path: NodePath<namedTypes.DecimalLiteral>,
  ): any;
  visitNullLiteral?(
    this: Context & M,
  ...
  visitClassAccessorProperty?(
    this: Context & M,
    path: NodePath<namedTypes.ClassAccessorProperty>,
  ): any;
  visitRestProperty?(
    this: Context & M,
  ...
  visitV8IntrinsicIdentifier?(
    this: Context & M,
    path: NodePath<namedTypes.V8IntrinsicIdentifier>,
  ): any;
  visitTopicReference?(
    this: Context & M,
    path: NodePath<namedTypes.TopicReference>,
  ): any;
  ...
  visitTSTypeCastExpression?(
    this: Context & M,
    path: NodePath<namedTypes.TSTypeCastExpression>,
  ): any;
  visitTSSatisfiesExpression?(
    this: Context & M,
    path: NodePath<namedTypes.TSSatisfiesExpression>,
  ): any;
  ...
  visitTSIntrinsicKeyword?(
    this: Context & M,
    path: NodePath<namedTypes.TSIntrinsicKeyword>,
  ): any;
  visitTSThisType?(
    this: Context & M,
  ...
  visitTSInstantiationExpression?(
    this: Context & M,
    path: NodePath<namedTypes.TSInstantiationExpression>,
  ): any;
