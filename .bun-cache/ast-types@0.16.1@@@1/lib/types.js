...
var PredicateType = /** @class */ ((_super) => {
...
function typesPlugin(_fork) {
  var Type = {
    ...
    def: (typeName) =>
      hasOwn.call(defCache, typeName)
        ? defCache[typeName]
        : (defCache[typeName] = new DefImpl(typeName)),
    hasDef: (typeName) => hasOwn.call(defCache, typeName),
  };
  var builtInCtorFns = [];
  ...
  var isBigInt =
    typeof BigInt === "function"
      ...
      : new PredicateType("BigInt", () => false);
  var builtInTypes = {
    string: isString,
    function: isFunction,
    array: isArray,
  ...
  var DefImpl = /** @class */ ((_super) => {
    tslib_1.__extends(DefImpl, _super);
    function DefImpl(typeName) {
      var _this =
        _super.call(
          this,
          new PredicateType(typeName, (value, deep) =>
            _this.check(value, deep),
          ),
          typeName,
        ) || this;
      return _this;
    ...
    DefImpl.prototype.build = function () {
      ...
      this.buildable = true;
      var addParam = (built, param, arg, isArgAvailable) => {
        ...
        if (isArgAvailable) {
          ...
          var message =
            ...
            this.typeName +
            "(" +
            this.buildParams.map((name) => all[name]).join(", ") +
            ")";
      ...
      var builder = () => {
        ...
        this.buildParams.forEach((param, i) => {
          if (i < argc) {
        ...
        Object.keys(this.allFields).forEach((param) => {
  ...
  function finalize() {
    Object.keys(defCache).forEach((name) => {
...
(0, shared_1.maybeSetModuleExports)(() => module);
