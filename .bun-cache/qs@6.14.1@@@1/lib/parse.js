...
var interpretNumericEntities = (str) =>
  str.replace(/&#(\d+);/g, ($0, numberStr) =>
    String.fromCharCode(parseInt(numberStr, 10)),
  );

var parseArrayValue = (val, options, currentArrayLength) => {
  if (
    val &&
    typeof val === "string" &&
    options.comma &&
...
var parseObject = (chain, val, options, valuesParsed) => {
