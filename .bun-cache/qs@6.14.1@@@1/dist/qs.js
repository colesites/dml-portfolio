(function (f) {
  ...
  return (() => {
  ...
  })()(
    {
      1: [
        (require, module, exports) => {
          ...
          module.exports = {
            ...
            formatters: {
              RFC1738: (e) => replace.call(e, percentTwenties, "+"),
              RFC3986: (e) => String(e),
            },
      ...
      3: [
        (require, module, exports) => {
          var utils = require(5),
            ...
            interpretNumericEntities = (e) =>
              e.replace(/&#(\d+);/g, (e, t) =>
                String.fromCharCode(parseInt(t, 10)),
              ),
            parseArrayValue = (e, t, r) => {
            ...
            parseValues = function parseQueryStringValues(e, t) {
              ...
              var a = t.parameterLimit === 1 / 0 ? void 0 : t.parameterLimit,
                o = i.split(t.delimiter, t.throwOnLimitExceeded ? a + 1 : a);
              if (t.throwOnLimitExceeded && o.length > a)
                throw new RangeError(
              ...
              for (l = 0; l < o.length; ++l)
                if (l !== n) {
                  ...
                  if (
                    (-1 === y
                      ? ((p = t.decoder(c, defaults.decoder, s, "key")),
                      ...
                      : null !==
                        ...
                        (d = utils.maybeMap(
                          parseArrayValue(
                            c.slice(y + 1),
                            t,
                            isArray(r[p]) ? r[p].length : 0,
                          ),
                          (e) => t.decoder(e, defaults.decoder, s, "value"),
                        )),
                    d &&
                      t.interpretNumericEntities &&
                      "iso-8859-1" === s &&
                      (d = interpretNumericEntities(String(d))),
                    c.indexOf("[]=") > -1 && (d = isArray(d) ? [d] : d),
                    null !== p)
                  ) {
                    var f = has.call(r, p);
            ...
            parseObject = (e, t, r, i) => {
              ...
              for (
                var l = i ? t : parseArrayValue(t, r, a), n = e.length - 1;
                n >= 0;
                --n
              ) {
                var s,
                  p = e[n];
                if ("[]" === p && r.parseArrays)
                  s = utils.isOverflow(l)
                    ? l
                    : r.allowEmptyArrays &&
                        ("" === l || (r.strictNullHandling && null === l))
                      ? []
                      : utils.combine([], l, r.arrayLimit, r.plainObjects);
                else {
                  ...
                  var d =
                      "[" === p.charAt(0) && "]" === p.charAt(p.length - 1)
                        ? p.slice(1, -1)
                        : p,
                    c = r.decodeDotInKeys ? d.replace(/%2E/g, ".") : d,
                    u = parseInt(c, 10);
                  r.parseArrays || "" !== c
                    ? !isNaN(u) &&
                      p !== c &&
            ...
            splitKeyIntoSegments = function splitKeyIntoSegments(e, t) {
              ...
              for (var n = 0; null !== (a = i.exec(r)) && n < t.depth; ) {
                n += 1;
                var s = a[1].slice(1, -1);
                if (
                  !t.plainObjects &&
              ...
              if (a) {
                ...
                l.push("[" + r.slice(a.index) + "]");
              }
              return l;
            },
            parseKeys = function parseQueryStringKeys(e, t, r, i) {
              if (e) {
                var a = splitKeyIntoSegments(e, r);
                if (a) return parseObject(a, t, r, i);
              }
            },
          ...
          module.exports = (e, t) => {
            ...
            for (
              var i = "string" == typeof e ? parseValues(e, r) : e,
              ...
              var n = o[l],
                s = parseKeys(n, i[n], r, "string" == typeof e);
              a = utils.merge(a, s, r);
            }
            return !0 === r.allowSparse ? a : utils.compact(a);
          };
        },
        { 5: 5 },
      ],
              ...
              if (
                ("function" == typeof f
                  ...
                  : g instanceof Date
                    ...
                    : "comma" === t &&
                      isArray(g) &&
                      (g = utils.maybeMap(g, (e) =>
                        e instanceof Date ? y(e) : e,
                      )),
                null === g)
              ) {
                ...
                return s
                  ? [
                      p(m ? r : s(r, defaults.encoder, h, "key", c)) +
                        "=" +
                        p(s(g, defaults.encoder, h, "value", c)),
                    ]
                  : [p(r) + "=" + p(String(g))];
              var S,
                E = [];
              if (void 0 === g) return E;
              if ("comma" === t && isArray(g))
                m && s && (g = utils.maybeMap(g, s)),
                  (S = [
                    { value: g.length > 0 ? g.join(",") || null : void 0 },
                  ]);
              else if (isArray(f)) S = f;
              else {
                var N = Object.keys(g);
                S = u ? N.sort(u) : N;
              }
              var T = l ? String(r).replace(/\./g, "%2E") : String(r),
                O = o && isArray(g) && 1 === g.length ? T + "[]" : T;
              if (a && isArray(g) && 0 === g.length) return O + "[]";
              for (var k = 0; k < S.length; ++k) {
                var I = S[k],
                  P =
                    "object" == typeof I && I && void 0 !== I.value
                      ? I.value
                      : g[I];
                if (!i || null !== P) {
                  var x = d && l ? String(I).replace(/\./g, "%2E") : String(I),
                    z = isArray(g)
                      ? "function" == typeof t
                        ? t(O, x)
                        : O
      ...
      5: [
        (require, module, exports) => {
          var formats = require(1),
            getSideChannel = require(46),
            has = Object.prototype.hasOwnProperty,
            isArray = Array.isArray,
            overflowChannel = getSideChannel(),
            markOverflow = function markOverflow(e, r) {
              return overflowChannel.set(e, r), e;
            },
            isOverflow = function isOverflow(e) {
              return overflowChannel.has(e);
            },
            getMaxIndex = function getMaxIndex(e) {
              return overflowChannel.get(e);
            },
            setMaxIndex = function setMaxIndex(e, r) {
              overflowChannel.set(e, r);
            },
            hexTable = (() => {
            ...
            arrayToObject = function arrayToObject(e, r) {
              for (
                var t = r && r.plainObjects ? { __proto__: null } : {}, o = 0;
                o < e.length;
                ++o
              )
                void 0 !== e[o] && (t[o] = e[o]);
            ...
            merge = function merge(e, r, t) {
              ...
              if ("object" != typeof r && "function" != typeof r) {
                if (isArray(e)) e.push(r);
                  ...
                  if (isOverflow(e)) {
                    var o = getMaxIndex(e) + 1;
                    (e[o] = r), setMaxIndex(e, o);
                  } else
              ...
              if (!e || "object" != typeof e) {
                if (isOverflow(r)) {
                  for (
                    ...
                    a[parseInt(n[c], 10) + 1] = r[n[c]];
                  return markOverflow(a, getMaxIndex(r) + 1);
                }
                return [e].concat(r);
              }
              var i = e;
              return (
                isArray(e) && !isArray(r) && (i = arrayToObject(e, t)),
                isArray(e) && isArray(r)
                  ? (r.forEach((r, o) => {
                      if (has.call(e, o)) {
                        var n = e[o];
            ...
            assign = function assignSingleSource(e, r) {
              return Object.keys(r).reduce((e, t) => ((e[t] = r[t]), e), e);
            },
            decode = (e, r, t) => {
              var o = e.replace(/\+/g, " ");
              if ("iso-8859-1" === t)
            ...
            encode = function encode(e, r, t, o, n) {
              ...
              for (var c = "", i = 0; i < a.length; i += limit) {
                for (
                  var l = a.length >= limit ? a.slice(i, i + limit) : a,
                    f = [],
                    s = 0;
                  s < l.length;
                  ++s
                  ...
                  (u >= 65 && u <= 90) ||
                  (u >= 97 && u <= 122) ||
                  (n === formats.RFC1738 && (40 === u || 41 === u))
                    ? (f[f.length] = l.charAt(s))
                    : u < 128
                      ? (f[f.length] = hexTable[u])
                      : u < 2048
                        ? (f[f.length] =
                            hexTable[192 | (u >> 6)] + hexTable[128 | (63 & u)])
                        : u < 55296 || u >= 57344
                          ? (f[f.length] =
                              hexTable[224 | (u >> 12)] +
                              hexTable[128 | ((u >> 6) & 63)] +
            ...
            combine = function combine(e, r, t, o) {
              if (isOverflow(e)) {
                var n = getMaxIndex(e) + 1;
                return (e[n] = r), setMaxIndex(e, n), e;
              }
              var a = [].concat(e, r);
              return a.length > t
                ? markOverflow(
                    arrayToObject(a, { plainObjects: o }),
                    a.length - 1,
                  )
                : a;
            },
      ...
      46: [
        (require, module, exports) => {
          var $TypeError = require(20),
            inspect = require(42),
            getSideChannelList = require(43),
            getSideChannelMap = require(44),
            getSideChannelWeakMap = require(45),
            makeChannel =
      ...
      10: [
        (require, module, exports) => {
          var bind = require(24),
            $TypeError = require(20),
            $call = require(9),
            $actualApply = require(7);
          module.exports = function callBindBasic(r) {
            if (r.length < 1 || "function" != typeof r[0])
              throw new $TypeError("a function is required");
            return $actualApply(bind, $call, r);
          };
        },
        { 20: 20, 24: 24, 7: 7, 9: 9 },
      ],
      ...
      12: [
        (require, module, exports) => {
          var GetIntrinsic = require(25),
            callBindBasic = require(10),
      ...
      25: [
        (require, module, exports) => {
          var undefined,
            $Object = require(22),
            $Error = require(16),
            $EvalError = require(15),
            $RangeError = require(17),
            $ReferenceError = require(18),
            $SyntaxError = require(19),
            $TypeError = require(20),
            $URIError = require(21),
            abs = require(34),
            floor = require(35),
            ...
            ThrowTypeError = $gOPD
              ...
              : throwTypeError,
            hasSymbols = require(31)(),
            getProto = require(28),
            $ObjectGPO = require(26),
            $ReflectGPO = require(27),
            $apply = require(8),
            $call = require(9),
            needsEval = {},
            TypedArray =
            ...
            INTRINSICS = {
              ...
              "%EvalError%": $EvalError,
              "%Float16Array%":
                "undefined" == typeof Float16Array ? undefined : Float16Array,
              "%Float32Array%":
            ...
            desc && "function" == typeof desc.get
              ...
              : "function" == typeof $getPrototypeOf &&
                function getDunder(t) {
                  return $getPrototypeOf(null == t ? t : $Object(t));
                };
        },
        { 10: 10, 30: 30 },
      ],
      ...
      41: [
        (require, module, exports) => {
          var $isNaN = require(36);
          module.exports = function sign(i) {
            return $isNaN(i) || 0 === i ? i : i < 0 ? -1 : 1;
          };
        },
        { 36: 36 },
      ],
      ...
      28: [
        (require, module, exports) => {
          var reflectGetProto = require(27),
            originalGetProto = require(26),
            getDunderProto = require(13);
          ...
          (function (global) {
            (() => {
              ...
              var utilInspect = require(6),
                ...
                quotes = { __proto__: null, double: '"', single: "'" },
                quoteREs = {
                  __proto__: null,
                  double: /(["\\])/g,
                  single: /(['\\])/g,
              ...
              function canTrustToString(t) {
                return (
                  !toStringTag ||
                  !(
                    "object" == typeof t &&
                    (toStringTag in t || void 0 !== t[toStringTag])
                  )
                );
              }
              function isArray(t) {
                return "[object Array]" === toStr(t) && canTrustToString(t);
              }
              function isDate(t) {
                return "[object Date]" === toStr(t) && canTrustToString(t);
              }
              function isRegExp(t) {
                return "[object RegExp]" === toStr(t) && canTrustToString(t);
              }
              function isError(t) {
                return "[object Error]" === toStr(t) && canTrustToString(t);
              }
              function isString(t) {
                return "[object String]" === toStr(t) && canTrustToString(t);
              }
              function isNumber(t) {
                return "[object Number]" === toStr(t) && canTrustToString(t);
              }
              function isBoolean(t) {
                return "[object Boolean]" === toStr(t) && canTrustToString(t);
              }
              function isSymbol(t) {
              ...
              module.exports = function inspect_(t, e, r, n) {
                var o = e || {};
                if (has(o, "quoteStyle") && !has(quotes, o.quoteStyle))
                  throw new TypeError(
                ...
                if ("object" == typeof t && i) {
                  if (
                    ...
                    return utilInspect(t, { depth: u - r });
                ...
                if (isMap(t)) {
                  ...
                  return (
                    mapForEach &&
                      mapForEach.call(t, (e, r) => {
                        d.push(inspect(r, t, !0) + " => " + inspect(e, t));
                      }),
                    collectionOf("Map", mapSize.call(t), d, p)
                  );
                }
                if (isSet(t)) {
                  var O = [];
                  return (
                    ...
                    collectionOf("Set", setSize.call(t), O, p)
                  );
                }
              ...
              function inspectString(t, e) {
                ...
                var o = quoteREs[e.quoteStyle || "single"];
                return (
                  (o.lastIndex = 0),
                  wrapQuotes(
                    $replace.call(
              ...
              function arrObjKeys(t, e) {
                ...
                if ("function" == typeof gOPS)
                  for (var u = 0; u < a.length; u++)
                    isEnumerable.call(t, a[u]) &&
                      n.push("[" + e(a[u]) + "]: " + e(t[a[u]], t));
                return n;
              }
            }).call(this);
          }).call(
          ...
          var inspect = require(42),
            ...
            listGetNode = (e, t, n) => {
              for (var i, r = e; null != (i = r.next); r = i)
                if (i.key === t)
                  return (
                    (r.next = i.next), n || ((i.next = e.next), (e.next = i)), i
                  );
            },
            listGet = (e, t) => {
              if (e) {
            ...
            listSet = (e, t, n) => {
              var i = listGetNode(e, t);
              i ? (i.value = n) : (e.next = { key: t, next: e.next, value: n });
            },
            listHas = (e, t) => !!e && !!listGetNode(e, t),
            listDelete = (e, t) => {
              ...
              var e,
                t = {
                  ...
                  delete: (t) => {
                    if (e) {
                      var n = $mapDelete(e, t);
                      return 0 === $mapSize(e) && (e = void 0), n;
                    }
                    return !1;
                  },
                  get: (t) => {
                    if (e) return $mapGet(e, t);
                  },
                  has: (t) => !!e && $mapHas(e, t),
                  set: (t, n) => {
                    e || (e = new $Map()), $mapSet(e, t, n);
                  },
                };
              return t;
            };
                  ...
                  a = {
                    ...
                    delete: (a) => {
                      if (
                        ...
                        if (e) return $weakMapDelete(e, a);
                      } else if (getSideChannelMap && t) return t.delete(a);
                      return !1;
                    },
                    get: (a) =>
                      $WeakMap &&
                    ...
                    set: (a, n) => {
                      ...
                      a &&
                      ("object" == typeof a || "function" == typeof a)
                        ? (e || (e = new $WeakMap()), $weakMapSet(e, a, n))
                        : getSideChannelMap &&
                          (t || (t = getSideChannelMap()), t.set(a, n));
                    },
                  };
                return a;
              }
