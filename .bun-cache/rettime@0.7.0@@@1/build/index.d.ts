...
declare class Emitter<EventMap extends DefaultEventMap> {
   ...
   */
  on<EventType extends keyof EventMap & string>(
    type: EventType,
   ...
   * @returns {AbortController} An `AbortController` that can be used to remove the listener.
   */
  once<EventType extends keyof EventMap & string>(
    type: EventType,
    listener: Emitter.ListenerType<typeof this, EventType, EventMap>,
   ...
   * @returns {AbortController} An `AbortController` that can be used to remove the listener.
   */
  earlyOn<EventType extends keyof EventMap & string>(
    type: EventType,
    listener: Emitter.ListenerType<typeof this, EventType, EventMap>,
    options?: TypedListenerOptions,
  ): typeof this;
   ...
   */
  earlyOnce<EventType extends keyof EventMap & string>(
    type: EventType,
    listener: Emitter.ListenerType<typeof this, EventType, EventMap>,
    options?: Omit<TypedListenerOptions, "once">,
  ): typeof this;
   ...
   */
  emit<EventType extends keyof EventMap & string>(
   ...
   */
  emitAsPromise<EventType extends keyof EventMap & string>(
    event: Brand<EventMap[EventType], EventType>,
  ): Promise<
   ...
   */
  emitAsGenerator<EventType extends keyof EventMap & string>(
    event: Brand<EventMap[EventType], EventType>,
  ): Generator<Emitter.ListenerReturnType<typeof this, EventType, EventMap>>;
  /**
   * Removes a listener for the given event type.
   */
  removeListener<EventType extends keyof EventMap & string>(
    type: EventType,
    listener: Emitter.ListenerType<typeof this, EventType, EventMap>,
  ): void;
  /**
   ...
   */
  removeAllListeners<EventType extends keyof EventMap & string>(
    type?: EventType,
  ): void;
  /**
   ...
   */
  listeners<EventType extends keyof EventMap & string>(
    type?: EventType,
   ...
   */
  listenerCount<EventType extends keyof EventMap & string>(
    type?: EventType,
  ): number;
}
