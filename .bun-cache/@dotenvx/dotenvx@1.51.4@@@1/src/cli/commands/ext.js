...
ext.description("🔌 extensions").allowUnknownOption();

// list known extensions here you want to display
ext.addHelpText(
  "after",
  "  vault                             🔐 manage .env.vault files",
);
...
ext
  ...
  .argument(
    "[directory]",
    "directory to prevent including .env files from",
    ".",
  )
...
ext
  ...
  .argument(
    "[directory]",
    "directory to prevent committing .env files from",
    ".",
  )
