...
program
  ...
  .option(
    "-o, --overload",
    "override existing env variables (by default, existing env vars take precedence over .env files)",
  )
  ...
  .option(
    "--ignore <errorCodes...>",
    "error code(s) to ignore (example: --ignore=MISSING_ENV_FILE)",
  )
...
program
  ...
  .option(
    "-ek, --exclude-key <excludeKeys...>",
    "keys(s) to exclude from encryption (default: none)",
  )
...
program
  ...
  .option(
    "-k, --key <keys...>",
    "keys(s) to decrypt (default: all keys in file)",
  )
  .option(
    "-ek, --exclude-key <excludeKeys...>",
    "keys(s) to exclude from decryption (default: none)",
  )
  .option("--stdout", "send to stdout")
  .action(function (...args) {
    this.envs = envs;
...
program
  ...
  .option(
    "-f, --env-file <filenames...>",
    "path(s) to your env file(s)",
    ".env*",
  )
  .option(
    "-ef, --exclude-env-file <excludeFilenames...>",
    "path(s) to exclude from your env file(s) (default: none)",
  )
  .action(lsAction);
...
program
  ...
  .action(function (...args) {
    logger.warn(
      "DEPRECATION NOTICE: [prebuild] has moved to [dotenvx ext prebuild]",
    );
...
program
  ...
  .action(function (...args) {
    logger.warn(
      "DEPRECATION NOTICE: [precommit] has moved to [dotenvx ext precommit]",
    );
