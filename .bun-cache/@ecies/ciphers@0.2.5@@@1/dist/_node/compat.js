...
var _compat = (algorithm, key, nonce, AAD) => {
  ...
  var encrypt = (plainText) => {
    var cipher = (0, node_crypto_1.createCipheriv)(
      algorithm,
      key,
      nonce,
      options,
  ...
  var decrypt = (cipherText) => {
    var rawCipherText = cipherText.subarray(
      0,
      cipherText.length - authTagLength,
    );
    var tag = cipherText.subarray(cipherText.length - authTagLength);
    var decipher = (0, node_crypto_1.createDecipheriv)(
      algorithm,
      key,
      nonce,
      options,
