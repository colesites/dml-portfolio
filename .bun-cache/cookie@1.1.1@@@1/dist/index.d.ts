 ...
 */
export declare function parseCookie(
  str: string,
 ...
 */
export declare function stringifyCookie(
  cookie: Cookies,
 ...
 *   => "foo=bar; httpOnly"
 */
export declare function stringifySetCookie(
  cookie: SetCookie,
  options?: StringifyOptions,
): string;
export declare function stringifySetCookie(
 ...
 */
export declare function parseSetCookie(
  str: string,
  options?: ParseOptions,
): SetCookie;
/**
