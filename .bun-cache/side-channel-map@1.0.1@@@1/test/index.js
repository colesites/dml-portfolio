...
test("getSideChannelMap", { skip: typeof Map !== "function" }, (t) => {
  var getSideChannel =
    getSideChannelMap ||
    (() => {
  ...
  t.test("has", (st) => {
    ...
    st.equal(
      channel.has("abc"),
      false,
      "non object value non existent yields false",
    );
    ...
    st.equal(
      channel.has("abc"),
      true,
      "non object value that exists yields true",
    );
  ...
  t.test("delete", (st) => {
    ...
    st.equal(
      channel["delete"]({}),
      false,
      "nonexistent value still yields false",
    );
...
test("getSideChannelMap, no Maps", { skip: typeof Map === "function" }, (t) => {
