...
describe("json-schema-traverse", () => {
  ...
  describe("Legacy v0.3.1 API", () => {
    ...
    it("should work when an options object is provided", () => {
  ...
  describe("pre and post", () => {
    ...
    it("should traverse schema in pre-order", () => {
    ...
    it("should traverse schema in post-order", () => {
    ...
    it("should traverse schema in pre- and post-order at the same time", () => {
