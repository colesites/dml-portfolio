...
class Printer {
  ...
  enterForStatementInit() {
    this.tokenContext |=
      ...
      _index.TokenContext.forInOrInitHeadAccumulate;
  ...
  enterDelimited() {
    ...
    if (
      !(oldTokenContext & _index.TokenContext.forInOrInitHeadAccumulate) &&
  ...
  word(str, noLineTerminatorAfter = false) {
    this.tokenContext &=
      _index.TokenContext.forInOrInitHeadAccumulatePassThroughMask;
