...
function n(t, o, a, h) {
  s = h;
  let l = {};
  if (Object.hasOwn(t, "extends")) {
    if ("string" != typeof t.extends) return l;
    const r = /\.json|\..*rc$/.test(t.extends);
    let h = null;
    if (r) h = ((t, e) => s.path.resolve(t, e))(o, t.extends);
    else
      try {
    ...
    !((t) => {
      if (i.indexOf(t) > -1)
        throw new e(`Circular extended configurations: '${t}'.`);
    })(h),
      i.push(h),
      (l = r ? JSON.parse(s.readFileSync(h, "utf8")) : require(t.extends)),
      delete t.extends,
      (l = n(l, s.path.dirname(h), a, s));
  }
...
function r(t, e) {
  ...
  for (const n of Object.keys(e))
    i(e[n]) && i(s[n]) ? (s[n] = r(t[n], e[n])) : (s[n] = e[n]);
  return s;
}
function o(t) {
  ...
  const n = { cmd: i.replace(s, ""), demanded: [], optional: [] };
  return (
    e.forEach((t, i) => {
      let r = !1;
      (t = t.replace(/\s/g, "")),
        /\.+[\]>]/.test(t) && i === e.length - 1 && (r = !0),
        /^\[/.test(t)
          ? n.optional.push({ cmd: t.replace(s, "").split("|"), variadic: r })
          : n.demanded.push({ cmd: t.replace(s, "").split("|"), variadic: r });
    }),
    n
  );
}
...
function h(t, s, i) {
  try {
    ...
    if (d < r.demanded.length)
      throw new e(
        `Not enough arguments provided. Expected ${r.demanded.length} but received ${f.length}.`,
      );
    const u = r.demanded.length + r.optional.length;
    if (d > u)
      throw new e(
        `Too many arguments provided. Expected max ${u} but received ${d}.`,
      );
    r.demanded.forEach((t) => {
      const e = l(f.shift());
      0 === t.cmd.filter((t) => t === e || "*" === t).length && c(e, t.cmd, n),
        (n += 1);
    }),
...
function c(t, s, i) {
  throw new e(
    `Invalid ${a[i] || "manyith"} argument. Expected ${s.join(" or ")} but received ${t}.`,
  );
}
function f(t) {
...
class _ {
  constructor(t, e, s, i) {
    (this.requireCache = new Set()),
      ...
      (this.shim = i),
      (this.usage = t),
      (this.globalMiddleware = s),
      (this.validation = e);
  }
  addDirectory(t, e, s, i) {
    "boolean" != typeof (i = i || {}).recurse && (i.recurse = !1),
      Array.isArray(i.extensions) || (i.extensions = ["js"]);
    ...
    (i.visit = (t, e, s) => {
      ...
      this.shim.requireDirectory({ require: e, filename: s }, t, i);
  }
  addHandler(t, e, s, i, n, r) {
    let a = [];
    const h = ((t) =>
      t ? t.map((t) => ((t.applyBeforeValidation = !1), t)) : [])(n);
    if (((i = i || (() => {})), Array.isArray(t)))
      if (((t) => t.every((t) => "string" == typeof t))(t)) [t, ...a] = t;
      else for (const e of t) this.addHandler(e);
    else {
      if (((t) => "object" == typeof t && !Array.isArray(t))(t)) {
        let e =
    ...
    if ("string" == typeof t) {
      ...
      a = a.map((t) => o(t).cmd);
      let l = !1;
      const c = [n.cmd].concat(a).filter((t) => !M.test(t) || ((l = !0), !1));
      0 === c.length && l && c.push("$0"),
        l && ((n.cmd = c[0]), (a = c.slice(1)), (t = t.replace(M, n.cmd))),
        a.forEach((t) => {
          this.aliasMap[t] = n.cmd;
        }),
        !1 !== e && this.usage.command(t, e, l, a, r),
        (this.handlers[n.cmd] = {
          original: t,
          description: e,
          handler: i,
  ...
  runCommand(t, e, s, i, n, r) {
    ...
    const c = this.applyBuilderUpdateUsageAndParse(
      l,
      o,
      e,
      s.aliases,
    ...
    if (x(h)) {
      ...
      if (f(c))
        return c.then((i) => {
          var a;
          return (
            (l = (a = i) && "function" == typeof a.getInternalMethods ? i : s),
            this.parseAndUpdateUsage(t, e, l, n, r, o)
          );
        });
    } else
      ((t) => "object" == typeof t)(h) &&
        (s.getInternalMethods().getUsageInstance().freeze(),
        (l = s.getInternalMethods().reset(i)),
  ...
  parseAndUpdateUsage(t, e, s, i, n, r) {
    t && s.getInternalMethods().getUsageInstance().unfreeze(!0),
      this.shouldUpdateUsage(s) &&
        s
          .getInternalMethods()
          .getUsageInstance()
          .usage(
            this.usageFromParentCommandsCommandHandler(i, e),
            e.description,
          );
    const o = s
      .getInternalMethods()
      .runYargsParserAndExecuteCommands(null, void 0, !0, n, r);
    return f(o)
      ? o.then((t) => ({ aliases: s.parsed.aliases, innerArgv: t }))
      : { aliases: s.parsed.aliases, innerArgv: o };
  }
  shouldUpdateUsage(t) {
    return (
  ...
  usageFromParentCommandsCommandHandler(t, e) {
    const s = M.test(e.original)
        ? e.original.replace(M, "").trim()
        : e.original,
      i = t.filter((t) => !M.test(t));
  ...
  handleValidationAndGetResult(t, e, s, i, n, r, o, a) {
    ...
    if (e.handler && !r.getInternalMethods().getHasOutput()) {
      ...
      r.getInternalMethods().postProcess(s, i, !1, !1),
        (s = j((s = C(s, r, o, !1)), (t) => {
          const s = e.handler(t);
          return f(s) ? s.then(() => t) : t;
        })),
        t || r.getInternalMethods().getUsageInstance().cacheHelpMessage(),
        f(s) &&
          !r.getInternalMethods().hasParseCallback() &&
          s.catch((t) => {
            try {
  ...
  applyMiddlewareAndGetResult(t, e, s, i, n, r, o) {
    let a = {};
    if (n) return s;
    o.getInternalMethods().getHasOutput() ||
      (a = this.populatePositionals(e, s, i, o));
    const h = this.globalMiddleware
        .getMiddleware()
        .slice(0)
        .concat(e.middlewares),
      l = C(s, o, h, !0);
    return f(l)
      ? l.then((s) => this.handleValidationAndGetResult(t, e, s, i, r, o, h, a))
      : this.handleValidationAndGetResult(t, e, l, i, r, o, h, a);
  }
  populatePositionals(t, e, s, i) {
    ...
    return (
      (e._ = s.commands.concat(e._.map((t) => "" + t))),
      this.postProcessPositionals(e, o, this.cmdToParseOptions(t.original), i),
      o
    );
  }
  populatePositional(t, e, s) {
    const i = t.cmd[0];
    t.variadic
      ? (s[i] = e._.splice(0).map(String))
      : e._.length && (s[i] = [String(e._.shift())]);
  }
  cmdToParseOptions(t) {
    const e = { array: [], default: {}, alias: {}, demand: {} },
      s = o(t);
    return (
      s.demanded.forEach((t) => {
        const [s, ...i] = t.cmd;
        t.variadic && (e.array.push(s), (e.default[s] = [])),
          (e.alias[s] = i),
          (e.demand[s] = !0);
      }),
  ...
  postProcessPositionals(t, e, s, i) {
    ...
    for (const t of Object.keys(s.alias))
      n.alias[t] = (n.alias[t] || []).concat(s.alias[t]);
    (n.array = n.array.concat(s.array)), (n.config = {});
    const r = [];
    if (
      (Object.keys(e).forEach((t) => {
        e[t].map((e) => {
          n.configuration["unknown-options-as-args"] && (n.key[t] = !0),
            r.push(`--${t}`),
            r.push(e);
        });
      }),
      ...
      return;
    const o = Object.assign({}, n.configuration, { "populate--": !1 }),
      a = this.shim.Parser.detailed(
        r,
        Object.assign({}, n, { configuration: o }),
      );
    if (a.error)
      i.getInternalMethods().getUsageInstance().fail(a.error.message, a.error);
    else {
      ...
      Object.keys(e).forEach((t) => {
        ...
        Object.keys(a.argv).forEach((n) => {
          s.includes(n) &&
            (e[n] || (e[n] = a.argv[n]),
            !this.isInConfigs(i, n) &&
            !this.isDefaulted(i, n) &&
            Object.hasOwn(t, n) &&
            Object.hasOwn(a.argv, n) &&
            (Array.isArray(t[n]) || Array.isArray(a.argv[n]))
              ? (t[n] = [].concat(t[n], a.argv[n]))
              : (t[n] = a.argv[n]));
        });
    }
  }
  isDefaulted(t, e) {
    const { default: s } = t.getOptions();
    return (
      Object.hasOwn(s, e) || Object.hasOwn(s, this.shim.Parser.camelCase(e))
    );
  }
  isInConfigs(t, e) {
    const { configObjects: s } = t.getOptions();
    return (
      s.some((t) => Object.hasOwn(t, e)) ||
      s.some((t) => Object.hasOwn(t, this.shim.Parser.camelCase(e)))
    );
  }
  runDefaultBuilderOn(t) {
    if (!this.defaultCommand) return;
    if (this.shouldUpdateUsage(t)) {
      const e = M.test(this.defaultCommand.original)
  ...
  moduleName(t) {
    const e = ((t) => {
      ...
      for (let e, s = 0, i = Object.keys(require.cache); s < i.length; s++)
        if (((e = require.cache[i[s]]), e.exports === t)) return e;
      return null;
    })(t);
    if (!e)
      throw new Error(
  ...
  extractDesc({ describe: t, description: e, desc: s }) {
...
function E(t) {
  "undefined" != typeof process &&
    [process.stdout, process.stderr].forEach((e) => {
      ...
      s._handle &&
        s.isTTY &&
        "function" == typeof s._handle.setBlocking &&
        s._handle.setBlocking(t);
    });
}
function A(t) {
...
function P(t, s) {
  ...
  let o = null,
    a = null,
    h = !0;
  n.showHelpOnFail = (e = !0, s) => {
    const [i, r] = "string" == typeof e ? [!0, e] : [e, s];
    return (
      t.getInternalMethods().isGlobalContext() && (a = r), (o = r), (h = i), n
    );
  };
  let l = !1;
  n.fail = (s, i) => {
  ...
  let c = [],
    f = !1;
  (n.usage = (t, e) =>
    null === t ? ((f = !0), (c = []), n) : ((f = !1), c.push([t, e || ""]), n)),
    (n.getUsage = () => c),
    (n.getUsageDisabled = () => f),
    (n.getPositionalGroupName = () => i("Positionals:"));
  let d = [];
  n.example = (t, e) => {
    d.push([t, e || ""]);
  };
  let u = [];
  (n.command = (t, e, s, i, n = !1) => {
  ...
  (n.wrap = (t) => {
    ...
    (n.getWrap = () =>
      s.getEnv("YARGS_DISABLE_WRAP")
        ? null
        : (b ||
            ((y = (() => {
              const t = 80;
              return s.process.stdColumns
                ? Math.min(t, s.process.stdColumns)
                : t;
            })()),
            (b = !0)),
          y));
  ...
  function O(t, e, i) {
    ...
    return (
      ...
      t.forEach((t) => {
        n = Math.max(
          s.stringWidth(i ? `${i} ${I(t[0])}` : I(t[0])) + $(t[0]),
          n,
        );
      }),
      e && (n = Math.min(n, parseInt((0.5 * e).toString(), 10))),
      n
    );
  }
  let w;
  ...
  (n.deferY18nLookup = (t) => v + t),
    (n.help = () => {
      ...
      !(() => {
        ...
        (Object.keys(s.alias) || []).forEach((i) => {
          s.alias[i].forEach((r) => {
            p[r] && n.describe(i, p[r]),
              r in e && t.demandOption(i, e[r]),
              s.boolean.includes(r) && t.boolean(i),
              s.count.includes(r) && t.count(i),
              s.string.includes(r) && t.string(i),
              s.normalize.includes(r) && t.normalize(i),
              s.array.includes(r) && t.array(i),
              s.number.includes(r) && t.number(i);
          });
        });
      })();
      const e = t.customScriptName ? t.$0 : s.path.basename(t.$0),
        ...
        l = t.getOptions();
      let g = [];
      (g = g.concat(Object.keys(p))),
        (g = g.concat(Object.keys(r))),
        (g = g.concat(Object.keys(o))),
        (g = g.concat(Object.keys(l.default))),
        (g = g.filter(C)),
        (g = Object.keys(
          g.reduce((t, e) => ("_" !== e && (t[e] = !0), t), {}),
        ));
      const y = n.getWrap(),
        b = s.cliui({ width: y, wrap: !!y });
      if (!f)
        if (c.length)
          c.forEach((t) => {
            b.div({ text: `${t[0].replace(/\$0/g, e)}` }),
              t[1] && b.div({ text: `${t[1]}`, padding: [1, 0, 0, 0] });
          }),
            b.div();
        else if (u.length) {
          let t = null;
      ...
      if (u.length > 1 || (1 === u.length && !u[0][2])) {
        ...
        !0 ===
          t.getInternalMethods().getParserConfiguration()["sort-commands"] &&
          (u = u.sort((t, e) => t[0].localeCompare(e[0])));
        const r = e ? `${e} ` : "";
        u.forEach((t) => {
          const s = `${r}${n}${t[0].replace(/^\$0 ?/, "")}`;
          b.span(
            { text: s, padding: [0, 2, 0, 2], width: O(u, y, `${e}${n}`) + 4 },
            { text: t[1] },
          );
          const o = [];
          t[2] && o.push(`[${i("default")}]`),
            t[3] &&
              t[3].length &&
              o.push(`[${i("aliases:")} ${t[3].join(", ")}]`),
            t[4] &&
              ("string" == typeof t[4]
                ? o.push(`[${i("deprecated: %s", t[4])}]`)
                : o.push(`[${i("deprecated")}]`)),
            o.length
              ? b.div({
                  text: o.join(" "),
      ...
      const M = (Object.keys(l.alias) || []).concat(
        Object.keys(t.parsed.newAliases) || [],
      );
      g = g.filter(
        (e) =>
          !t.parsed.newAliases[e] &&
          M.every((t) => -1 === (l.alias[t] || []).indexOf(e)),
      );
      const _ = i("Options:");
      h[_] || (h[_] = []),
        ((t, e, s, i) => {
          ...
          Object.keys(s).forEach((t) => {
            ...
            t.forEach((t) => {
              (r = [t].concat(e[t])),
                r.some((t) => -1 !== n.indexOf(t)) || s[i].push(t);
            });
        })(g, l.alias, h, _);
      const k = (t) => /^--/.test(I(t)),
        x = Object.keys(h)
          ...
          .map((t) => ({
            ...
            normalizedKeys: h[t].filter(C).map((t) => {
              ...
              for (let e, s = 0; void 0 !== (e = M[s]); s++)
                if ((l.alias[e] || []).includes(t)) return e;
              return t;
            }),
          }))
            ...
            const s = e.reduce(
              (e, s) => (
                (e[s] = [s]
                  .concat(l.alias[s] || [])
                  .map((e) =>
                    t === n.getPositionalGroupName()
                      ? e
                      : (/^[0-9]$/.test(e)
                          ? l.boolean.includes(s)
                            ? "-"
                            : "--"
                          : e.length > 1
                            ? "--"
                  ...
                  .sort((t, e) => (k(t) === k(e) ? 0 : k(t) ? 1 : -1))
                  .join(", ")),
                e
              ),
              {},
            );
            return { groupName: t, normalizedKeys: e, switches: s };
          });
      if (
        (x
          .filter(({ groupName: t }) => t !== n.getPositionalGroupName())
          .some(
            ({ normalizedKeys: t, switches: e }) => !t.every((t) => k(e[t])),
          ) &&
          x
            .filter(({ groupName: t }) => t !== n.getPositionalGroupName())
              ...
              t.forEach((t) => {
                ...
                k(e[t]) &&
                  (e[t] =
                    ...
                    (i = 4),
                    S(s)
                      ? { text: s.text, indentation: s.indentation + i }
                      : { text: s, indentation: i }));
              });
            }),
        x.forEach(({ groupName: e, normalizedKeys: s, switches: o }) => {
          b.div(e),
            s.forEach((e) => {
              const s = o[e];
              let h = p[e] || "",
                c = null;
              h.includes(v) && (h = i(h.substring(16))),
                l.boolean.includes(e) && (c = `[${i("boolean")}]`),
                l.count.includes(e) && (c = `[${i("count")}]`),
                l.string.includes(e) && (c = `[${i("string")}]`),
                l.normalize.includes(e) && (c = `[${i("string")}]`),
                l.array.includes(e) && (c = `[${i("array")}]`),
                l.number.includes(e) && (c = `[${i("number")}]`);
              const f = [
                e in a
                  ? ((d = a[e]),
                    "string" == typeof d
                  ...
                  : null,
                c,
                e in r ? `[${i("required")}]` : null,
                l.choices && l.choices[e]
                  ? `[${i("choices:")} ${n.stringifiedValues(l.choices[e])}]`
                  : null,
                j(l.default[e], l.defaultDescription[e]),
              ]
                .filter(Boolean)
                .join(" ");
              var d;
              ...
              const u =
                !0 ===
                t.getInternalMethods().getUsageConfiguration()["hide-types"];
              f && !u
                ? b.div({ text: f, padding: [0, 0, 0, 2], align: "right" })
                : b.div();
            }),
            b.div();
        }),
        d.length &&
          ...
          d.forEach((t) => {
            "" === t[1]
              ? b.div({ text: t[0], padding: [0, 2, 0, 2] })
              : b.div(
                  { text: t[0], padding: [0, 2, 0, 2], width: O(d, y) + 4 },
                  { text: t[1] },
                );
          }),
          b.div()),
    ...
    (n.clearCachedHelpMessage = () => {
      w = void 0;
    }),
    (n.hasCachedHelpMessage = () => !!w),
    (n.showHelp = (e) => {
      const s = t.getInternalMethods().getLoggerInstance();
      e || (e = "error");
      ("function" == typeof e ? e : s[e])(n.help());
    }),
    (n.functionDescription = (t) =>
      [
        "(",
        t.name ? s.Parser.decamelize(t.name, "-") : i("generated-value"),
        ")",
      ].join("")),
    (n.stringifiedValues = (t, e) => {
      let s = "";
      const i = e || ", ",
        n = [].concat(t);
      return t && n.length
...
class D {
  constructor(t, e, s, i) {
    ...
    (this.yargs = t),
      ...
      (this.zshShell =
        null !==
          (o =
            (null === (n = this.shim.getEnv("SHELL")) || void 0 === n
              ? void 0
              : n.includes("zsh")) ||
            (null === (r = this.shim.getEnv("ZSH_NAME")) || void 0 === r
              ? void 0
              : r.includes("zsh"))) &&
        void 0 !== o &&
        o);
  ...
  defaultCompletion(t, e, s, i) {
    ...
    const r = [];
    this.commandCompletions(r, t, s),
      this.optionCompletions(r, t, e, s),
      this.choicesFromOptionsCompletions(r, t, e, s),
      this.choicesFromPositionalsCompletions(r, t, e, s),
      i(null, r);
  }
  ...
  optionCompletions(t, e, s, i) {
    if (
      ...
      Object.keys(s.key).forEach((r) => {
        const o =
          !!s.configuration["boolean-negation"] && s.boolean.includes(r);
        n.includes(r) ||
          s.hiddenOptions.includes(r) ||
          this.argsContainKey(e, r, o) ||
          this.completeOptionKey(r, t, i, o && !!s.default[r]);
      });
    }
  }
  ...
  getPreviousArgChoices(t) {
    ...
    let e = t[t.length - 1],
      s = "";
    if (
      (!e.startsWith("-") && t.length > 1 && ((s = e), (e = t[t.length - 2])),
      !e.startsWith("-"))
    )
      return;
    const i = e.replace(/^-+/, ""),
    ...
    let o;
    for (const t of r)
      if (Object.hasOwn(n.key, t) && Array.isArray(n.choices[t])) {
        o = n.choices[t];
        break;
      }
    ...
    if (this.zshShell) {
      const e = this.usage.getDescriptions(),
        s =
          null ===
            (r =
              null === (n = null == this ? void 0 : this.aliases) ||
              void 0 === n
                ? void 0
                : n[t]) || void 0 === r
            ? void 0
        ...
        i = s ? e[s] : void 0,
        l =
          null !== (a = null !== (o = e[t]) && void 0 !== o ? o : i) &&
          void 0 !== a
            ? a
            : "";
      h = `${t.replace(/:/g, "\\:")}:${l.replace("__yargsString__:", "").replace(/(\r\n|\n|\r)/gm, " ")}`;
    }
    const l = !/^--/.test(s) && ((t) => /^[^0-9]$/.test(t))(t) ? "-" : "--";
    e.push(l + h), i && e.push(l + "no-" + h);
  }
  customCompletion(t, e, s, i) {
    ...
    return ((t) => t.length > 3)(this.customCompletionFunction)
      ? this.customCompletionFunction(
          s,
          e,
          (n = i) => this.defaultCompletion(t, e, s, n),
          (t) => {
            i(null, t);
          },
        )
  ...
  getCompletion(t, e) {
    const s = t.length ? t[t.length - 1] : "",
      ...
      n = this.customCompletionFunction
        ? (i) => this.customCompletion(t, i, s, e)
        : (i) => this.defaultCompletion(t, i, s, e);
  ...
  generateCompletionScript(t, e) {
    ...
    return (
      t.match(/\.js$/) && (t = `./${t}`),
      (s = s.replace(/{{app_name}}/g, i)),
      (s = s.replace(/{{completion_command}}/g, e)),
      s.replace(/{{app_path}}/g, t)
    );
  }
  registerFunction(t) {
  ...
  for (i = 1; i <= e.length; i++)
    for (n = 1; n <= t.length; n++)
      e.charAt(i - 1) === t.charAt(n - 1)
        ...
        : i > 1 &&
            n > 1 &&
            e.charAt(i - 2) === t.charAt(n - 1) &&
            e.charAt(i - 1) === t.charAt(n - 2)
          ? (s[i][n] = s[i - 2][n - 2] + 1)
          : (s[i][n] = Math.min(
              s[i - 1][n - 1] + 1,
              Math.min(s[i][n - 1] + 1, s[i - 1][n] + 1),
            ));
...
const bt = Symbol("copyDoubleDash"),
  vt = Symbol("copyDoubleDash"),
  Ot = Symbol("deleteFromParserHintObject"),
  wt = Symbol("emitWarning"),
  Ct = Symbol("freeze"),
  jt = Symbol("getDollarZero"),
  Mt = Symbol("getParserConfiguration"),
  _t = Symbol("getUsageConfiguration"),
  kt = Symbol("guessLocale"),
  xt = Symbol("guessVersion"),
  Et = Symbol("parsePositionalNumbers"),
  At = Symbol("pkgUp"),
  Pt = Symbol("populateParserHintArray"),
  St = Symbol("populateParserHintSingleValueDictionary"),
  $t = Symbol("populateParserHintArrayDictionary"),
  It = Symbol("populateParserHintDictionary"),
  Dt = Symbol("sanitizeKey"),
  Nt = Symbol("setKey"),
  Ht = Symbol("unfreeze"),
  zt = Symbol("validateAsync"),
  Wt = Symbol("getCommandInstance"),
  qt = Symbol("getContext"),
  Ut = Symbol("getHasOutput"),
  Ft = Symbol("getLoggerInstance"),
  Lt = Symbol("getParseContext"),
  Vt = Symbol("getUsageInstance"),
  Gt = Symbol("getValidationInstance"),
  Rt = Symbol("hasParseCallback"),
  Tt = Symbol("isGlobalContext"),
  Bt = Symbol("postProcess"),
  Yt = Symbol("rebase"),
  Kt = Symbol("reset"),
  Jt = Symbol("runYargsParserAndExecuteCommands"),
  Zt = Symbol("runValidation"),
  Xt = Symbol("setHasOutput"),
  Qt = Symbol("kTrackManuallySetKeys");
class te {
  constructor(t = [], e, s, i) {
  ...
  addHelpOpt(t, e) {
    return (
      h("[string|boolean] [string]", [t, e], arguments.length),
      v(this, Z, "f") && (this[Ot](v(this, Z, "f")), O(this, Z, null, "f")),
      (!1 === t && void 0 === e) ||
        (O(this, Z, "string" == typeof t ? t : "help", "f"),
        this.boolean(v(this, Z, "f")),
        this.describe(
          v(this, Z, "f"),
          e || v(this, pt, "f").deferY18nLookup("Show help"),
        )),
      this
    );
  }
  ...
  addShowHiddenOpt(t, e) {
    ...
    return (
      ...
      this.describe(
        s,
        e || v(this, pt, "f").deferY18nLookup("Show hidden options"),
      ),
      (v(this, et, "f").showHiddenOpt = s),
      this
    );
  }
  showHidden(t, e) {
  ...
  alias(t, e) {
    return (
      h("<object|string|array> [string|array]", [t, e], arguments.length),
      this[$t](this.alias.bind(this), "alias", t, e),
      this
    );
  }
  array(t) {
    return (
      h("<array|string>", [t], arguments.length),
      this[Pt]("array", t),
      this[Qt](t),
      this
    );
  ...
  check(t, e) {
    return (
      h("<function> [boolean]", [t, e], arguments.length),
      this.middleware(
        (e, s) =>
          j(
            () => t(e, s.getOptions()),
            (s) => (
              s
                ? ("string" == typeof s || s instanceof Error) &&
                  v(this, pt, "f").fail(s.toString(), s)
                : v(this, pt, "f").fail(
                    v(this, ct, "f").y18n.__(
            ...
            (t) => (
              v(this, pt, "f").fail(t.message ? t.message : t.toString(), t), e
            ),
          ),
        !1,
        e,
  ...
  choices(t, e) {
    return (
      h("<object|string|array> [string|array]", [t, e], arguments.length),
      this[$t](this.choices.bind(this), "choices", t, e),
      this
    );
  }
  coerce(t, s) {
    if (
      (h("<object|string|array> [function]", [t, s], arguments.length),
      Array.isArray(t))
    ) {
    ...
    return (
      (v(this, et, "f").key[t] = !0),
      v(this, Y, "f").addCoerceMiddleware((i, n) => {
        let r;
        return Object.hasOwn(i, t)
          ? j(
              () => ((r = n.getAliases()), s(i[t])),
              (e) => {
                i[t] = e;
                const s = n.getInternalMethods().getParserConfiguration()[
                  "strip-aliased"
                ];
  ...
  conflicts(t, e) {
    return (
      h("<string|object> [string|array]", [t, e], arguments.length),
      v(this, yt, "f").conflicts(t, e),
      this
    );
  }
  config(t = "config", e, s) {
    return (
      ...
      "object" != typeof t || Array.isArray(t)
        ? ("function" == typeof e && ((s = e), (e = void 0)),
          this.describe(
            t,
            e || v(this, pt, "f").deferY18nLookup("Path to JSON config file"),
          ),
  ...
  completion(t, e, s) {
    return (
      ...
      "function" == typeof e && ((s = e), (e = void 0)),
      O(this, F, t || v(this, F, "f") || "completion", "f"),
      e || !1 === e || (e = "generate completion script"),
      this.command(v(this, F, "f"), e),
      s && v(this, U, "f").registerFunction(s),
      this
    );
  }
  command(t, e, s, i, n, r) {
    return (
      ...
      v(this, z, "f").addHandler(t, e, s, i, n, r),
      this
    );
  }
  ...
  commandDir(t, e) {
    ...
    return (
      v(this, z, "f").addDirectory(t, s, v(this, ct, "f").getCallerFile(), e),
      this
    );
  }
  count(t) {
  ...
  default(t, e, s) {
    return (
      h("<object|string|array> [*] [string]", [t, e, s], arguments.length),
      s &&
        (u(t, v(this, ct, "f")), (v(this, et, "f").defaultDescription[t] = s)),
      "function" == typeof e &&
        (u(t, v(this, ct, "f")),
        v(this, et, "f").defaultDescription[t] ||
          (v(this, et, "f").defaultDescription[t] = v(
            this,
            pt,
            "f",
          ).functionDescription(e)),
        (e = e.call())),
      this[St](this.default.bind(this), "default", t, e),
      this
    );
  }
  defaults(t, e, s) {
  ...
  demand(t, e, s) {
    return (
      Array.isArray(e)
        ...
        : "number" != typeof e && ((s = e), (e = 1 / 0)),
      "number" == typeof t
        ? (d(s, !0, v(this, ct, "f")), this.demandCommand(t, e, s, s))
        : Array.isArray(t)
          ? t.forEach((t) => {
              d(s, !0, v(this, ct, "f")), this.demandOption(t, s);
            })
          : "string" == typeof s
            ? this.demandOption(t, s)
            : (!0 !== s && void 0 !== s) || this.demandOption(t),
      this
    );
  }
  demandOption(t, e) {
    return (
      h("<object|string|array> [string]", [t, e], arguments.length),
      this[St](this.demandOption.bind(this), "demandedOptions", t, e),
      this
    );
  }
  deprecateOption(t, e) {
    return (
      h("<string> [string|boolean]", [t, e], arguments.length),
      (v(this, et, "f").deprecatedOptions[t] = e),
      this
    );
  }
  describe(t, e) {
  ...
  env(t) {
    return (
      h("[string|boolean]", [t], arguments.length),
      !1 === t
        ? delete v(this, et, "f").envPrefix
        : (v(this, et, "f").envPrefix = t || ""),
      this
    );
  }
  epilogue(t) {
    return (
      h("<string>", [t], arguments.length), v(this, pt, "f").epilog(t), this
    );
  }
  epilog(t) {
  ...
  exit(t, e) {
    O(this, J, !0, "f"),
      O(this, V, e, "f"),
      v(this, T, "f") && v(this, ct, "f").process.exit(t);
  }
  exitProcess(t = !0) {
  ...
  fail(t) {
    if (
      (h("<function|boolean>", [t], arguments.length),
  ...
  async getCompletion(t, e) {
    return (
      h("<array> [function]", [t, e], arguments.length),
      e
        ? v(this, U, "f").getCompletion(t, e)
        : new Promise((e, s) => {
            v(this, U, "f").getCompletion(t, (t, i) => {
              t ? s(t) : e(i);
            });
          })
    );
  ...
  getHelp() {
    if ((O(this, J, !0, "f"), !v(this, pt, "f").hasCachedHelpMessage())) {
      if (!this.parsed) {
        const t = this[Jt](v(this, ht, "f"), void 0, void 0, 0, !0);
  ...
  global(t, e) {
    return (
      h("<string|array> [boolean]", [t, e], arguments.length),
      (t = [].concat(t)),
      !1 !== e
        ...
        : t.forEach((t) => {
            v(this, et, "f").local.includes(t) ||
              v(this, et, "f").local.push(t);
          }),
      this
    );
  }
  group(t, e) {
    h("<string|array> <string>", [t, e], arguments.length);
    const s = v(this, at, "f")[e] || v(this, K, "f")[e];
  ...
  hide(t) {
    return (
      h("<string>", [t], arguments.length),
      v(this, et, "f").hiddenOptions.push(t),
      this
    );
  }
  implies(t, e) {
    return (
      h("<string|object> [number|string|array]", [t, e], arguments.length),
      v(this, yt, "f").implies(t, e),
      this
    );
  }
  locale(t) {
    return (
      ...
      void 0 === t
        ...
        : (O(this, G, !1, "f"), v(this, ct, "f").y18n.setLocale(t), this)
    );
  }
  middleware(t, e, s) {
    return v(this, Y, "f").addMiddleware(t, !!e, s);
  }
  nargs(t, e) {
    return (
      h("<string|object|array> [number]", [t, e], arguments.length),
      this[St](this.nargs.bind(this), "narg", t, e),
      this
    );
  }
  normalize(t) {
    return (
      h("<array|string>", [t], arguments.length), this[Pt]("normalize", t), this
    );
  }
  number(t) {
    return (
  ...
  option(t, e) {
    if (
      (h("<string|object> [object]", [t, e], arguments.length),
      "object" == typeof t)
    )
      Object.keys(t).forEach((e) => {
        this.options(e, t[e]);
      ...
      "object" != typeof e && (e = {}),
        this[Qt](t),
        !v(this, mt, "f") ||
          ("version" !== t && "version" !== (null == e ? void 0 : e.alias)) ||
          this[wt](
            [
  ...
  parse(t, e, s) {
    h(
      ...
      this[Ct](),
      void 0 === t && (t = v(this, ht, "f")),
      "object" == typeof e && (O(this, rt, e, "f"), (e = s)),
      "function" == typeof e && (O(this, nt, e, "f"), (e = !1)),
      e || O(this, ht, t, "f"),
      v(this, nt, "f") && O(this, T, !1, "f");
    const i = this[Jt](t, !!e),
      n = this.parsed;
    return (
      ...
      f(i)
        ? i
            ...
            .catch((t) => {
              throw (
                (v(this, nt, "f") &&
                  v(this, nt, "f")(t, this.parsed.argv, v(this, tt, "f")),
                t)
              );
            })
            .finally(() => {
        ...
        : (v(this, nt, "f") &&
            v(this, nt, "f").call(this, v(this, V, "f"), i, v(this, tt, "f")),
          this[Ht](),
          (this.parsed = n),
          i)
    );
  ...
  positional(t, e) {
    ...
    const i = v(this, q, "f").fullCommands[
        v(this, q, "f").fullCommands.length - 1
      ],
      n = i
        ? v(this, z, "f").cmdToParseOptions(i)
    ...
    return (
      ...
      this.group(t, v(this, pt, "f").getPositionalGroupName()),
      this.option(t, e)
    );
  }
  ...
  requiresArg(t) {
    return (
      h("<array|string|object> [number]", [t], arguments.length),
      ("string" == typeof t && v(this, et, "f").narg[t]) ||
        this[St](this.requiresArg.bind(this), "narg", t, NaN),
      this
    );
  }
  showCompletionScript(t, e) {
    return (
      ...
      (t = t || this.$0),
      v(this, Q, "f").log(
        v(this, U, "f").generateCompletionScript(
          t,
          e || v(this, F, "f") || "completion",
        ),
      ),
      this
    );
  ...
  showHelp(t) {
    if (
      (h("[string|function]", [t], arguments.length),
      O(this, J, !0, "f"),
      !v(this, pt, "f").hasCachedHelpMessage())
    ) {
      if (!this.parsed) {
        const e = this[Jt](v(this, ht, "f"), void 0, void 0, 0, !0);
        if (f(e))
          return (
            e.then(() => {
  ...
  showHelpOnFail(t, e) {
    return (
      h("[boolean|string] [string]", [t, e], arguments.length),
      v(this, pt, "f").showHelpOnFail(t, e),
      this
    );
  }
  showVersion(t) {
  ...
  skipValidation(t) {
    return (
      h("<array|string>", [t], arguments.length),
      this[Pt]("skipValidation", t),
      this
    );
  }
  strict(t) {
    return (
      h("[boolean]", [t], arguments.length), O(this, ft, !1 !== t, "f"), this
    );
  }
  strictCommands(t) {
    return (
      h("[boolean]", [t], arguments.length), O(this, dt, !1 !== t, "f"), this
    );
  }
  strictOptions(t) {
    return (
      h("[boolean]", [t], arguments.length), O(this, ut, !1 !== t, "f"), this
    );
  }
  string(t) {
    return (
  ...
  updateStrings(t) {
    return (
      h("<object>", [t], arguments.length),
      O(this, G, !1, "f"),
      v(this, ct, "f").y18n.updateLocale(t),
      this
    );
  }
  usage(t, s, i, n) {
    if (
      ...
      if ((d(t, null, v(this, ct, "f")), (t || "").match(/^\$0( |$)/)))
        return this.command(t, s, i, n);
      throw new e(
  ...
  usageConfiguration(t) {
    return h("<object>", [t], arguments.length), O(this, gt, t, "f"), this;
  }
  version(t, e, s) {
    const i = "version";
    if (
      (h("[boolean|string] [string] [string]", [t, e, s], arguments.length),
      v(this, mt, "f") &&
        (this[Ot](v(this, mt, "f")),
    ...
    return (
      O(this, mt, "string" == typeof t ? t : i, "f"),
      (e = e || v(this, pt, "f").deferY18nLookup("Show version number")),
      v(this, pt, "f").version(s || void 0),
      this.boolean(v(this, mt, "f")),
      this.describe(v(this, mt, "f"), e),
      this
    );
  }
  wrap(t) {
    return (
      h("<number|null|undefined>", [t], arguments.length),
      v(this, pt, "f").wrap(t),
      this
    );
  }
  ...
  [vt]() {
    return {
      log: (...t) => {
        this[Rt]() || console.log(...t),
          O(this, J, !0, "f"),
          v(this, tt, "f").length && O(this, tt, v(this, tt, "f") + "\n", "f"),
          O(this, tt, v(this, tt, "f") + t.join(" "), "f");
      },
      error: (...t) => {
        this[Rt]() || console.error(...t),
          O(this, J, !0, "f"),
          v(this, tt, "f").length && O(this, tt, v(this, tt, "f") + "\n", "f"),
          O(this, tt, v(this, tt, "f") + t.join(" "), "f");
      },
  ...
  [Ot](t) {
    p(v(this, et, "f")).forEach((e) => {
      ...
      Array.isArray(s)
        ? s.includes(t) && s.splice(s.indexOf(t), 1)
        : "object" == typeof s && delete s[t];
    }),
      delete v(this, pt, "f").getDescriptions()[t];
  }
  [wt](t, e, s) {
    v(this, R, "f")[s] ||
      (v(this, ct, "f").process.emitWarning(t, e), (v(this, R, "f")[s] = !0));
  }
  [Ct]() {
    v(this, B, "f").push({
      options: v(this, et, "f"),
  ...
  [Et](t) {
    const e = t["--"] ? t["--"] : t._;
    for (let t, s = 0; void 0 !== (t = e[s]); s++)
      v(this, ct, "f").Parser.looksLikeNumber(t) &&
  ...
  [At](t) {
    ...
    try {
      ...
      !t &&
        v(this, ct, "f").path.extname(e) &&
        (e = v(this, ct, "f").path.dirname(e));
      const i = v(this, ct, "f").findUp(e, (t, e) =>
        e.includes("package.json") ? "package.json" : void 0,
      );
      d(i, void 0, v(this, ct, "f")),
        (s = JSON.parse(v(this, ct, "f").readFileSync(i, "utf8")));
    } catch (t) {}
    return (v(this, ot, "f")[e] = s || {}), v(this, ot, "f")[e];
  }
  [Pt](t, e) {
    (e = [].concat(e)).forEach((e) => {
      (e = this[Dt](e)), v(this, et, "f")[t].push(e);
    });
  }
  [St](t, e, s, i) {
    this[It](t, e, s, i, (t, e, s) => {
      v(this, et, "f")[t][e] = s;
    });
  }
  [$t](t, e, s, i) {
  ...
  [It](t, e, s, i, n) {
    ...
    else if (((t) => "object" == typeof t)(s)) for (const e of p(s)) t(e, s[e]);
    else n(e, this[Dt](s), i);
  }
  [Dt](t) {
    return "__proto__" === t ? "___proto___" : t;
  }
  [Nt](t, e) {
    return this[St](this[Nt].bind(this), "key", t, e), this;
  }
  [Ht]() {
    var t, e, s, i, n, r, o, a, h, l, c, f;
    const u = v(this, B, "f").pop();
    let p;
    d(u, void 0, v(this, ct, "f")),
      (t = this),
      (e = this),
      (s = this),
      (i = this),
  ...
  [Bt](t, e, s, i) {
    ...
    return (
      (this[Mt]()["parse-positional-numbers"] ||
        ...
        (t = this[Et](t)),
      i && (t = C(t, this, v(this, Y, "f").getMiddleware(), !1)),
      t
    );
  }
  [Kt](t = {}) {
    O(this, et, v(this, et, "f") || {}, "f");
    const e = {};
    (e.local = v(this, et, "f").local || []),
      (e.configObjects = v(this, et, "f").configObjects || []);
    const s = {};
    e.local.forEach((e) => {
      (s[e] = !0),
        (t[e] || []).forEach((t) => {
      ...
      Object.assign(
        v(this, at, "f"),
        Object.keys(v(this, K, "f")).reduce((t, e) => {
          const i = v(this, K, "f")[e].filter((t) => !(t in s));
    ...
    return (
      ...
      (e.envPrefix = v(this, et, "f").envPrefix),
      O(this, et, e, "f"),
      O(
        this,
        pt,
          ...
          : ((t, e, s) => {
              const i = s.y18n.__,
                ...
                r = {
                  nonOptionCount: (s) => {
                    const i = t.getDemandedCommands(),
                      r =
                        s._.length +
                        (s["--"] ? s["--"].length : 0) -
                        t.getInternalMethods().getContext().commands.length;
                    i._ &&
                      (r < i._.min || r > i._.max) &&
                      (r < i._.min
                        ? void 0 !== i._.minMsg
                          ? e.fail(
                              i._.minMsg
                                ? i._.minMsg
                                    .replace(/\$0/g, r.toString())
                                    .replace(/\$1/, i._.min.toString())
                                : null,
                            )
                          : e.fail(
                              n(
                  ...
                  requiredArguments: (t, s) => {
                    let i = null;
                    for (const e of Object.keys(s))
                      (Object.hasOwn(t, e) && void 0 !== t[e]) ||
                        ((i = i || {}), (i[e] = s[e]));
                    if (i) {
                      const t = [];
                      ...
                      e.fail(
                        n(
                          ...
                          Object.keys(i).join(", ") + s,
                        ),
                      );
                    }
                  },
                  unknownArguments: (s, i, o, a, h = !0) => {
                    var l;
                    const c = t
                        .getInternalMethods()
                        .getCommandInstance()
                    ...
                    if (
                      (Object.keys(s).forEach((e) => {
                        H.includes(e) ||
                          ...
                          r.isValidAndSomeAliasIsNotNew(e, i) ||
                          f.push(e);
                      }),
                      h &&
                        (d.commands.length > 0 || c.length > 0 || a) &&
                        s._.slice(d.commands.length).forEach((t) => {
                          c.includes("" + t) || f.push("" + t);
                        }),
                      h)
                    ) {
                      const e =
                          (null === (l = t.getDemandedCommands()._) ||
                          void 0 === l
                            ? void 0
                            : l.max) || 0,
                        i = d.commands.length + e;
                      i < s._.length &&
                        s._.slice(i).forEach((t) => {
                          (t = String(t)),
                            d.commands.includes(t) ||
                              f.includes(t) ||
                              f.push(t);
                        });
                    }
                  ...
                  unknownCommands: (s) => {
                    ...
                    return (
                      (o.commands.length > 0 || i.length > 0) &&
                        s._.slice(o.commands.length).forEach((t) => {
                  ...
                  isValidAndSomeAliasIsNotNew: (e, s) => {
                    if (!Object.hasOwn(s, e)) return !1;
                    const i = t.parsed.newAliases;
                    return [e, ...s[e]].some(
                      (t) => !Object.hasOwn(i, t) || !i[e],
                    );
                  },
                  limitedChoices: (s) => {
                    ...
                    Object.keys(s).forEach((t) => {
                      -1 === H.indexOf(t) &&
                        Object.hasOwn(n.choices, t) &&
                        [].concat(s[t]).forEach((e) => {
                          -1 === n.choices[t].indexOf(e) &&
                            void 0 !== e &&
                            (r[t] = (r[t] || []).concat(e));
                        });
                    });
              ...
              let l = {};
              (r.conflicts = (e, s) => {
                h("<string|object> [array|string]", [e, s], arguments.length),
                  "object" == typeof e
                    ? Object.keys(e).forEach((t) => {
                        r.conflicts(t, e[t]);
                      })
                  ...
                  Object.keys(n).forEach((t) => {
                    ...
                    t.getInternalMethods().getParserConfiguration()[
                      ...
                      Object.keys(l).forEach((t) => {
                        l[t].forEach((r) => {
                          r &&
                            void 0 !== n[s.Parser.camelCase(t)] &&
                            void 0 !== n[s.Parser.camelCase(r)] &&
                            e.fail(
                              i(
                                "Arguments %s and %s are mutually exclusive",
                                t,
                ...
                (r.reset = (t) => (
                  (o = g(o, (e) => !t[e])), (l = g(l, (e) => !t[e])), r
                ));
              const c = [];
              return (
                (r.freeze = () => {
                  c.push({ implied: o, conflicting: l });
                }),
                (r.unfreeze = () => {
                  const t = c.pop();
                  d(t, void 0, s), ({ implied: o, conflicting: l } = t);
                }),
                r
              );
  ...
  [Jt](t, s, i, n = 0, r = !1) {
    ...
    const a = !!v(this, et, "f").configuration["populate--"],
      ...
      l = v(this, ct, "f").Parser.detailed(
        t,
        Object.assign({}, v(this, et, "f"), {
          configuration: { "parse-positional-numbers": !1, ...h },
        }),
      ),
    ...
    Object.keys(c).forEach((t) => {
      t === v(this, Z, "f") && c[t]
        ? (p = !0)
        : t === v(this, mt, "f") && c[t] && (g = !0);
    }),
      (c.$0 = this.$0),
      (this.parsed = l),
      0 === n && v(this, pt, "f").clearCachedHelpMessage();
    try {
      ...
      const h = v(this, z, "f").getCommands(),
        m = v(this, U, "f").completionKey in c,
        y = p || m || r;
      if (c._.length) {
        if (h.length) {
          let t;
          for (let e, s = n || 0; void 0 !== c._[s]; s++) {
            if (
              ((e = String(c._[s])), h.includes(e) && e !== v(this, F, "f"))
            ) {
              const t = v(this, z, "f").runCommand(
                e,
                this,
                l,
                s + 1,
          ...
          !v(this, z, "f").hasDefaultCommand() &&
            ...
            t &&
            !y &&
            v(this, yt, "f").recommendCommands(t, h);
        }
        v(this, F, "f") &&
          c._.includes(v(this, F, "f")) &&
          !m &&
          (v(this, T, "f") && E(!0), this.showCompletionScript(), this.exit(0));
      }
      ...
      if (m) {
        v(this, T, "f") && E(!0);
        const s = (t = [].concat(t)).slice(
          t.indexOf(`--${v(this, U, "f").completionKey}`) + 1,
        );
        return (
          v(this, U, "f").getCompletion(s, (t, s) => {
      ...
      if (
        ...
        !o &&
          ...
          (o = Object.keys(c).some(
            (t) =>
              v(this, et, "f").skipValidation.indexOf(t) >= 0 && !0 === c[t],
          )),
        !o)
      ) {
        if (l.error) throw new e(l.error.message);
        if (!m) {
          const t = this[Zt](u, {}, l.error);
          i || (d = C(c, this, v(this, Y, "f").getMiddleware(), !0)),
            (d = this[zt](t, null != d ? d : c)),
            f(d) &&
              !i &&
              (d = d.then(() =>
                C(c, this, v(this, Y, "f").getMiddleware(), !1),
              ));
        }
      }
    } catch (t) {
  ...
  [Zt](t, s, i, n) {
    ...
    return (o) => {
      ...
      v(this, yt, "f").nonOptionCount(o),
        v(this, yt, "f").requiredArguments(o, r);
      let a = !1;
      v(this, dt, "f") && (a = v(this, yt, "f").unknownCommands(o)),
        v(this, ft, "f") && !a
          ? v(this, yt, "f").unknownArguments(o, t, s, !!n)
          : v(this, ut, "f") &&
            v(this, yt, "f").unknownArguments(o, t, {}, !1, !1),
        v(this, yt, "f").limitedChoices(o),
        v(this, yt, "f").implications(o),
        v(this, yt, "f").conflicting(o);
    };
  }
  [Xt]() {
    O(this, J, !0, "f");
  ...
  [Qt](t) {
    if ("string" == typeof t) v(this, et, "f").key[t] = !0;
    else for (const e of t) v(this, et, "f").key[e] = !0;
  }
}
var ee, se;
const { readFileSync: ie } = require("fs"),
  { inspect: ne } = require("util"),
  { resolve: re } = require("path"),
  oe = require("y18n"),
  ae = require("yargs-parser");
var he,
  le = {
    ...
    mainFilename:
      null !==
        (se =
          null ===
            (ee =
              null === require || void 0 === require ? void 0 : require.main) ||
          void 0 === ee
            ? void 0
    ...
    y18n: oe({ directory: re(__dirname, "../locales"), updateFiles: !1 }),
  };
const ce = (
  null ===
    (he = null === process || void 0 === process ? void 0 : process.env) ||
  void 0 === he
    ? void 0
...
var de,
  ue = {
    ...
    Yargs:
      ((de = le),
      (t = [], e = de.process.cwd(), s) => {
        const i = new te(t, e, s, de);
        return (
          Object.defineProperty(i, "argv", {
            get: () => i.parse(),
            enumerable: !0,
          }),
          i.help(),
