...
export function validation(yargs, usage, shim) {
  ...
  self.requiredArguments = function requiredArguments(argv, demandedOptions) {
    ...
    for (const key of Object.keys(demandedOptions)) {
      if (!Object.hasOwn(argv, key) || typeof argv[key] === "undefined") {
        missing = missing || {};
  ...
  self.unknownArguments = function unknownArguments(
    ...
    Object.keys(argv).forEach((key) => {
      if (
        ...
        !Object.hasOwn(positionalMap, key) &&
        !Object.hasOwn(yargs.getInternalMethods().getParseContext(), key) &&
  ...
  self.isValidAndSomeAliasIsNotNew = function isValidAndSomeAliasIsNotNew(
    ...
    return [key, ...aliases[key]].some(
      (a) => !Object.hasOwn(newAliases, a) || !newAliases[key],
    );
  };
  self.limitedChoices = function limitedChoices(argv) {
    ...
    Object.keys(argv).forEach((key) => {
      if (
        ...
        Object.hasOwn(options.choices, key)
      ) {
