...
export class YargsInstance {
  ...
  coerce(keys, value) {
    ...
    __classPrivateFieldGet(
      ...
      let aliases;
      const shouldCoerce = Object.hasOwn(argv, keys);
      if (!shouldCoerce) {
        return argv;
      }
      return maybeAsyncResult(
  ...
  option(key, opt) {
    ...
    if (typeof key === "object") {
      ...
      if (!Object.hasOwn(descriptions, key) || typeof desc === "string") {
  ...
  [kPopulateParserHintArrayDictionary](builder, type, key, value) {
    this[kPopulateParserHintDictionary](
      ...
      (type, key, value) => {
        __classPrivateFieldGet(this, _YargsInstance_options, "f")[type][key] = (
          __classPrivateFieldGet(this, _YargsInstance_options, "f")[type][
            key
          ] || []
        ).concat(value);
      },
