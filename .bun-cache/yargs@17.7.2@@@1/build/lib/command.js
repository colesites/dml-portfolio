...
export class CommandInstance {
      ...
      Object.keys(parsed.argv).forEach((key) => {
        if (positionalKeys.includes(key)) {
          ...
          if (
            ...
            Object.hasOwn(argv, key) &&
            Object.hasOwn(parsed.argv, key) &&
  ...
  isDefaulted(yargs, key) {
    ...
    return (
      ...
      Object.hasOwn(defaults, this.shim.Parser.camelCase(key))
    );
  }
  isInConfigs(yargs, key) {
    const { configObjects } = yargs.getOptions();
    return (
      configObjects.some((c) => Object.hasOwn(c, key)) ||
      configObjects.some((c) =>
        Object.hasOwn(c, this.shim.Parser.camelCase(key)),
      )
    );
  }
