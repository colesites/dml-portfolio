...
var Diff = /** @class */ (() => {
  ...
  Diff.prototype.diffWithOptionsObj = function (
    oldTokens,
    newTokens,
    options,
    callback,
  ...
  Diff.prototype.addToPath = (path, added, removed, oldPosInc, options) => {
  ...
  Diff.prototype.extractCommon = function (
    basePath,
    newTokens,
    oldTokens,
    diagonalPath,
  ...
  Diff.prototype.equals = (left, right, options) => {
  ...
  Diff.prototype.removeEmpty = (array) => {
    var ret = [];
  ...
  Diff.prototype.castInput = (value, options) => value;
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  Diff.prototype.tokenize = (value, options) => Array.from(value);
  Diff.prototype.join = (chars) => {
