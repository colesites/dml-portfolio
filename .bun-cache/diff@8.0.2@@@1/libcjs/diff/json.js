...
var JsonDiff = /** @class */ ((_super) => {
  ...
  JsonDiff.prototype.castInput = (value, options) => {
    var undefinedReplacement = options.undefinedReplacement,
      _a = options.stringifyReplacer,
      stringifyReplacer =
        _a === void 0
          ? (k, v) => (typeof v === "undefined" ? undefinedReplacement : v)
          : _a;
  ...
  JsonDiff.prototype.equals = function (left, right, options) {
    return _super.prototype.equals.call(
      this,
      left.replace(/,([\r\n])/g, "$1"),
      right.replace(/,([\r\n])/g, "$1"),
      options,
...
function canonicalize(obj, stack, replacementStack, replacer, key) {
  ...
  if (typeof obj === "object" && obj !== null) {
    ...
    for (i = 0; i < sortedKeys.length; i += 1) {
      key_1 = sortedKeys[i];
      canonicalizedObj[key_1] = canonicalize(
        obj[key_1],
        stack,
        replacementStack,
        replacer,
