...
export type DiffCallbackAbortable<T> = (
  result: ChangeObject<T>[] | undefined,
) => void;
...
export type DiffArraysOptionsAbortable<T> = DiffArraysOptions<T> &
...
export type DiffCharsOptionsAbortable = DiffCharsOptions &
  AbortableDiffOptions &
...
export type DiffLinesOptionsAbortable = DiffLinesOptions &
  AbortableDiffOptions &
  Partial<CallbackOptionAbortable<string>>;
...
export type DiffWordsOptionsAbortable = DiffWordsOptions &
  AbortableDiffOptions &
  Partial<CallbackOptionAbortable<string>>;
...
export type DiffSentencesOptionsAbortable = DiffSentencesOptions &
  AbortableDiffOptions &
  Partial<CallbackOptionAbortable<string>>;
...
export type DiffJsonOptionsAbortable = DiffJsonOptions &
  AbortableDiffOptions &
  Partial<CallbackOptionAbortable<string>>;
...
export type DiffCssOptionsAbortable = DiffJsonOptions &
  AbortableDiffOptions &
  Partial<CallbackOptionAbortable<string>>;
/**
 ...
 */
export type AllDiffOptions = DiffArraysOptions<unknown> &
  DiffCharsOptions &
  DiffWordsOptions &
  DiffLinesOptions &
  DiffJsonOptions;
