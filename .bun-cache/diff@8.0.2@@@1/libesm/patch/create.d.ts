...
type StructuredPatchCallbackAbortable = (
  patch: StructuredPatch | undefined,
) => void;
...
export type StructuredPatchOptionsAbortable = _StructuredPatchOptionsAbortable &
  AbortableDiffOptions;
export interface StructuredPatchOptionsNonabortable
  extends Pick<
    DiffLinesOptionsNonabortable,
    "ignoreWhitespace" | "stripTrailingCr"
  > {
 ...
 */
export declare function structuredPatch(
  oldFileName: string,
  newFileName: string,
  oldStr: string,
  newStr: string,
 ...
 */
export declare function formatPatch(
...
interface _CreatePatchOptionsAbortable
  extends Pick<
    DiffLinesOptionsAbortable,
    "ignoreWhitespace" | "stripTrailingCr"
  > {
...
export type CreatePatchOptionsAbortable = _CreatePatchOptionsAbortable &
  AbortableDiffOptions;
export interface CreatePatchOptionsNonabortable
  extends Pick<
    DiffLinesOptionsNonabortable,
    "ignoreWhitespace" | "stripTrailingCr"
  > {
