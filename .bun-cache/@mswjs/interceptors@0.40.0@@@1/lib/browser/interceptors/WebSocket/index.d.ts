...
type StrictEventListenerOrEventListenerObject<EventType extends Event> =
...
declare class WebSocketOverride extends EventTarget implements WebSocket {
  ...
  set onmessage(listener: WebSocketEventListener<
...
declare abstract class WebSocketClientConnectionProtocol {
  ...
  abstract addEventListener<EventType extends keyof WebSocketClientEventMap>(
    type: EventType,
    listener: WebSocketEventListener<WebSocketClientEventMap[EventType]>,
    options?: AddEventListenerOptions | boolean,
  ): void;
  abstract removeEventListener<EventType extends keyof WebSocketClientEventMap>(
    event: EventType,
    listener: WebSocketEventListener<WebSocketClientEventMap[EventType]>,
 ...
 */
declare class WebSocketClassTransport
  extends EventTarget
...
declare abstract class WebSocketServerConnectionProtocol {
  ...
  abstract send(data: WebSocketData): void;
  abstract close(): void;
  abstract addEventListener<EventType extends keyof WebSocketServerEventMap>(
    event: EventType,
    listener: WebSocketEventListener<WebSocketServerEventMap[EventType]>,
    options?: AddEventListenerOptions | boolean,
  ): void;
  abstract removeEventListener<EventType extends keyof WebSocketServerEventMap>(
    event: EventType,
    listener: WebSocketEventListener<WebSocketServerEventMap[EventType]>,
    options?: EventListenerOptions | boolean,
  ): void;
  ...
  implements WebSocketServerConnectionProtocol
{
  ...
  private [kEmitter];
  constructor(
    client: WebSocketOverride,
    transport: WebSocketClassTransport,
...
export {
  ...
  WebSocketData,
  WebSocketEventMap$1 as WebSocketEventMap,
