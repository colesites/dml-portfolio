...
} from "./glossary-f7ee1c9d.js";
import {
  I as Interceptor,
  E as ExtractEventNames,
} from "./Interceptor-af98b768.js";
export {
  c as INTERNAL_REQUEST_ID_HEADER_NAME,
  a as InterceptorEventMap,
  e as InterceptorReadyState,
  b as InterceptorSubscription,
  d as deleteGlobalSymbol,
  g as getGlobalSymbol,
} from "./Interceptor-af98b768.js";
import { EventMap, Listener } from "strict-event-emitter";
import "@open-draft/logger";

interface BatchInterceptorOptions<
  InterceptorList extends ReadonlyArray<Interceptor<any>>,
> {
  name: string;
  interceptors: InterceptorList;
}
type ExtractEventMapType<
  InterceptorList extends ReadonlyArray<Interceptor<any>>,
 ...
 */
declare class BatchInterceptor<
  InterceptorList extends ReadonlyArray<Interceptor<any>>,
