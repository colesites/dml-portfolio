 ...
 */
declare const INTERNAL_REQUEST_ID_HEADER_NAME =
...
type ExtractEventNames<Events extends Record<string, any>> =
...
declare class Interceptor<Events extends InterceptorEventMap> {
   ...
   */
  on<EventName extends ExtractEventNames<Events>>(
    event: EventName,
    listener: Listener<Events[EventName]>,
  ): this;
  once<EventName extends ExtractEventNames<Events>>(
    event: EventName,
    listener: Listener<Events[EventName]>,
  ): this;
  off<EventName extends ExtractEventNames<Events>>(
    event: EventName,
    listener: Listener<Events[EventName]>,
  ): this;
  removeAllListeners<EventName extends ExtractEventNames<Events>>(
    event?: EventName,
  ): this;
  /**
...
export {
  ExtractEventNames as E,
  HttpRequestEventMap as H,
  IS_PATCHED_MODULE as I,
  RequestController as R,
  RequestControllerSource as a,
  RequestCredentials as b,
  InterceptorEventMap as c,
  InterceptorSubscription as d,
  INTERNAL_REQUEST_ID_HEADER_NAME as e,
  deleteGlobalSymbol as f,
  getGlobalSymbol as g,
  InterceptorReadyState as h,
  Interceptor as i,
};
