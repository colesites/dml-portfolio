...
// src/interceptors/fetch/index.ts
var _FetchInterceptor = class extends _chunkDOWWQYXZjs.Interceptor {
  constructor() {
  ...
  async setup() {
    ...
    globalThis.fetch = async (input, init) => {
      ...
      const resolvedInput =
        ...
        !_chunkDOWWQYXZjs.canParseUrl.call(void 0, input)
          ? new URL(input, location.href)
          : input;
      const request = new Request(resolvedInput, init);
      if (input instanceof Request) {
        _chunkSRMAQGPMjs.setRawRequest.call(void 0, request, input);
      }
      ...
      const controller = new (0, _chunkDOWWQYXZjs.RequestController)(request, {
        passthrough: async () => {
          ...
          if (this.emitter.listenerCount("response") > 0) {
            ...
            await _chunk7Q53NNPVjs.emitAsync.call(
              void 0,
              this.emitter,
              "response",
              {
        ...
        respondWith: async (rawResponse) => {
          if (_chunk7Q53NNPVjs.isResponseError.call(void 0, rawResponse)) {
          ...
          const response =
            decompressedStream === null
              ? rawResponse
              : new (0, _chunkDOWWQYXZjs.FetchResponse)(
                  decompressedStream,
                  rawResponse,
                );
          _chunkDOWWQYXZjs.FetchResponse.setUrl(request.url, response);
          if (
            _chunkDOWWQYXZjs.FetchResponse.isRedirectResponse(response.status)
          ) {
    ...
    Object.defineProperty(
      globalThis.fetch,
      _chunk73NOP3T5js.IS_PATCHED_MODULE,
      {
        enumerable: true,
        configurable: true,
        value: true,
...
//# sourceMappingURL=chunk-FRZQJNBO.js.map
