...
function _encrypt(receiverRawPK, data) {
  ...
  var sharedKey = ephemeralSK.encapsulate(
    receiverPK,
    (0, config_1.isHkdfKeyCompressed)(),
  );
  var ephemeralPK = ephemeralSK.publicKey.toBytes(
    (0, config_1.isEphemeralKeyCompressed)(),
  );
...
function _decrypt(receiverRawSK, data) {
  ...
  var sharedKey = ephemeralPK.decapsulate(
    receiverSK,
    (0, config_1.isHkdfKeyCompressed)(),
  );
...
Object.defineProperty(exports, "ECIES_CONFIG", {
  enumerable: true,
  get: () => config_2.ECIES_CONFIG,
});
var keys_2 = require("./keys");
Object.defineProperty(exports, "PrivateKey", {
  enumerable: true,
  get: () => keys_2.PrivateKey,
});
Object.defineProperty(exports, "PublicKey", {
  enumerable: true,
  get: () => keys_2.PublicKey,
});
