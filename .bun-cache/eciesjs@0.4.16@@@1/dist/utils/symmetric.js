...
var symEncrypt = (key, plainText, AAD) => _exec(_encrypt, key, plainText, AAD);
exports.symEncrypt = symEncrypt;
var symDecrypt = (key, cipherText, AAD) =>
  _exec(_decrypt, key, cipherText, AAD);
...
function _exec(callback, key, data, AAD) {
  ...
  if (algorithm === "aes-256-gcm") {
    return callback(
      ...
      key,
      data,
      (0, config_1.symmetricNonceLength)(),
      consts_1.AEAD_TAG_LENGTH,
      AAD,
    );
    ...
    return callback(
      ...
      key,
      data,
      consts_1.XCHACHA20_NONCE_LENGTH,
      consts_1.AEAD_TAG_LENGTH,
      AAD,
    );
