  ...
  function _Headers(init) {
    ...
    if (
      ["Headers", "HeadersPolyfill"].includes(
        (_init = init) === null || _init === void 0
          ? void 0
          : _init.constructor.name,
      ) ||
      _instanceof(init, _Headers) ||
      (typeof globalThis.Headers !== "undefined" &&
        _instanceof(init, globalThis.Headers))
    ) {
  ...
  _create_class(_Headers, [
          ...
          switch (_state.label) {
            ...
            case 2:
              if ((_iteratorNormalCompletion = (_step = _iterator.next()).done))
                return [3, 5];
              (_step_value = _sliced_to_array(_step.value, 1)),
                (name = _step_value[0]);
              return [4, name];
            case 3:
              _state.sent();
        ...
        return _ts_generator(this, function (_state) {
          switch (_state.label) {
            ...
            case 2:
              if ((_iteratorNormalCompletion = (_step = _iterator.next()).done))
                return [3, 5];
              (_step_value = _sliced_to_array(_step.value, 2)),
                (value = _step_value[1]);
              return [4, value];
            case 3:
              _state.sent();
    ...
    },
    {
      ...
      value: function entries() {
        ...
        return _ts_generator(this, function (_state) {
          switch (_state.label) {
            case 0:
              sortedKeys = Object.keys(this[NORMALIZED_HEADERS]).sort((a, b) =>
                a.localeCompare(b),
              );
              (_iteratorNormalCompletion = true),
                (_didIteratorError = false),
    ...
    },
    {
      ...
      value: function get(name) {
        ...
        return (_this_NORMALIZED_HEADERS_normalizeHeaderName =
          this[NORMALIZED_HEADERS][normalizeHeaderName(name)]) !== null &&
          _this_NORMALIZED_HEADERS_normalizeHeaderName !== void 0
          ? _this_NORMALIZED_HEADERS_normalizeHeaderName
          : null;
      },
    },
    {
    ...
    },
    {
      ...
      value: function append(name, value) {
        ...
        var resolvedValue = this.has(normalizedName)
          ? "".concat(this.get(normalizedName), ", ").concat(normalizedValue)
          : normalizedValue;
    ...
    },
    {
      ...
      value: function forEach(callback, thisArg) {
        ...
        try {
          for (
            var _iterator = this.entries()[Symbol.iterator](), _step;
            !(_iteratorNormalCompletion = (_step = _iterator.next()).done);
            _iteratorNormalCompletion = true
          ) {
    ...
    },
    {
      ...
      value: function getSetCookie() {
        ...
        return (0, import_set_cookie_parser.splitCookiesString)(
          setCookieHeader,
        );
      },
    },
...
function getRawHeaders(headers) {
  ...
  try {
    for (
      var _iterator = headers.entries()[Symbol.iterator](), _step;
      !(_iteratorNormalCompletion = (_step = _iterator.next()).done);
      _iteratorNormalCompletion = true
    ) {
      var _step_value = _sliced_to_array(_step.value, 2),
...
function reduceHeadersObject(headers, reducer, initialState) {
  return Object.keys(headers).reduce(
    (nextHeaders, name) => reducer(nextHeaders, name, headers[name]),
    initialState,
  );
}
