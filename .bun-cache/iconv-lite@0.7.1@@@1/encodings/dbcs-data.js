...
module.exports = {
  ...
  shiftjis: {
    type: "_dbcs",
    table: () => require("./tables/shiftjis.json"),
    encodeAdd: { "\u00a5": 0x5c, "\u203E": 0x7e },
  ...
  eucjp: {
    type: "_dbcs",
    table: () => require("./tables/eucjp.json"),
    encodeAdd: { "\u00a5": 0x5c, "\u203E": 0x7e },
  },
  ...
  cp936: {
    type: "_dbcs",
    table: () => require("./tables/cp936.json"),
  },
  ...
  gbk: {
    type: "_dbcs",
    table: () =>
      require("./tables/cp936.json").concat(require("./tables/gbk-added.json")),
  },
  xgbk: "gbk",
  isoir58: "gbk",
  ...
  gb18030: {
    ...
    table: () =>
      require("./tables/cp936.json").concat(require("./tables/gbk-added.json")),
    gb18030: () => require("./tables/gb18030-ranges.json"),
    encodeSkipVals: [0x80],
    encodeAdd: { "€": 0xa2e3 },
  },
  ...
  cp949: {
    type: "_dbcs",
    table: () => require("./tables/cp949.json"),
  },
  ...
  cp950: {
    type: "_dbcs",
    table: () => require("./tables/cp950.json"),
  },
  ...
  big5hkscs: {
    type: "_dbcs",
    table: () =>
      require("./tables/cp950.json").concat(
