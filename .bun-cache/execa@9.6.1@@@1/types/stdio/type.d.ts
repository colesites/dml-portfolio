...
import type { Not, And, Or, Unless, AndUnless } from "../utils.js";
import type {
  GeneratorTransform,
...
type IsStandardStream<FdNumber extends string> =
  FdNumber extends keyof StandardStreams ? true : false;
...
type IterableObject<IsArray extends boolean> = Iterable<unknown> &
  object & { readonly BYTES_PER_ELEMENT?: never } & AndUnless<
    IsArray,
...
type OutputStdioOption<IsSync extends boolean, IsArray extends boolean> =
  | 1
  | 2
...
export type StdioSingleOptionItems<StdioOptionType> =
