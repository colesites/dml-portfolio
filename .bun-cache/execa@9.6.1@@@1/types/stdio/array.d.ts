...
export type StdioOptionNormalizedArray<OptionsType extends CommonOptions> =
  StdioOptionNormalized<OptionsType["stdio"]>;

type StdioOptionNormalized<StdioOption extends CommonOptions["stdio"]> =
  StdioOption extends StdioOptionsArray
    ? StdioOption
