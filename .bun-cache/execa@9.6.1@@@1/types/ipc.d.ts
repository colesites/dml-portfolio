...
export function getOneMessage(
  getOneMessageOptions?: GetOneMessageOptions<Options["serialization"]>,
): Promise<Message>;
...
This requires the `ipc` option to be `true`. The type of `message` depends on the `serialization` option.
*/
export function getEachMessage(
...
> = IpcEnabled extends true
  ? {
      ...
      /**
		...
		*/
      getOneMessage(
        getOneMessageOptions?: GetOneMessageOptions<Serialization>,
      ): Promise<Message<Serialization>>;
      ...
      getEachMessage(
        getEachMessageOptions?: GetEachMessageOptions,
      ): AsyncIterableIterator<Message<Serialization>>;
    }
...
export type HasIpc<OptionsType extends Options> = HasIpcOption<
  ...
  "gracefulCancel" extends keyof OptionsType
    ? OptionsType["gracefulCancel"]
    : undefined
>;
