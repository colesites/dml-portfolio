...
// `subprocess.stdio`
export type SubprocessStdioArray<OptionsType extends Options> = MapStdioStreams<
  StdioOptionNormalizedArray<OptionsType>,
  OptionsType
>;
...
type MapStdioStreams<StdioOptionsArrayType, OptionsType extends Options> = [
  SubprocessStdioStream<"0", OptionsType>,
  SubprocessStdioStream<"1", OptionsType>,
  SubprocessStdioStream<"2", OptionsType>,
  "3" extends keyof StdioOptionsArrayType
    ? SubprocessStdioStream<"3", OptionsType>
    : never,
  "4" extends keyof StdioOptionsArrayType
    ? SubprocessStdioStream<"4", OptionsType>
    : never,
];
