...
type ExecaCustomSubprocess<OptionsType extends Options> = {
  ...
  /**
	...
	*/
  [Symbol.asyncIterator](): SubprocessAsyncIterable<
    undefined,
  ...
  /**
	...
	*/
  iterable<IterableOptions extends ReadableOptions = {}>(
    readableOptions?: IterableOptions,
  ): SubprocessAsyncIterable<
    IterableOptions["binary"],
    OptionsType["encoding"]
  >;
...
*/
export type Subprocess<OptionsType extends Options = Options> = Omit<
  ChildProcess,
  keyof ExecaCustomSubprocess<OptionsType>
> &
...
export type ResultPromise<OptionsType extends Options = Options> =
  Subprocess<OptionsType> & Promise<Result<OptionsType>>;
