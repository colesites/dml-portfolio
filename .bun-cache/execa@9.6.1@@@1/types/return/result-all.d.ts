...
// `result.all`
export type ResultAll<OptionsType extends CommonOptions> = ResultAllProperty<
  OptionsType["all"],
  OptionsType
>;
...
type AllMainFd<OptionsType extends CommonOptions> = IgnoresResultOutput<
  "1",
  OptionsType
> extends true
  ? "2"
...
type AllObjectFd<OptionsType extends CommonOptions> = IsObjectFd<
  "1",
  OptionsType
> extends true
  ? "1"
...
type AllLinesFd<OptionsType extends CommonOptions> = FdSpecificOption<
  OptionsType["lines"],
  "1"
> extends true
  ? "1"
