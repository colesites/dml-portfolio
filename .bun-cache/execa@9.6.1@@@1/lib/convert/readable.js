...
export const createReadable = (
  ...
  const readable = new Readable({
    read,
    destroy: callbackify(
      onReadableDestroy.bind(undefined, {
        subprocessStdout,
        subprocess,
        waitReadableDestroy,
      }),
...
export const getReadableOptions = (
...
export const getReadableMethods = ({
  subprocessStdout,
  subprocess,
  binary,
  encoding,
...
export const onStdoutFinished = async ({
  subprocessStdout,
  onStdoutDataDone,
  readable,
  subprocess,
...
export const onReadableDestroy = async (
