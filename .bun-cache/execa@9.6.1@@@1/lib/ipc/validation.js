...
export const validateIpcMethod = ({
  methodName,
  isSubprocess,
  ipc,
  isConnected,
...
export const getStrictResponseError = (error, isSubprocess) =>
  new Error(
...
export const getAbortDisconnectError = () =>
  new Error(
...
export const handleSerializationError = ({
  error,
  methodName,
  isSubprocess,
  message,
...
const isSerializationError = ({ code, message }) =>
...
const getMethodName = (methodName, isSubprocess, parameters = "") =>
...
const getOtherProcessName = (isSubprocess) =>
