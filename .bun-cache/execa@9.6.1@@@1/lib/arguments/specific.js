...
const getStdioLength = ({ stdio }) =>
  Array.isArray(stdio)
    ? Math.max(stdio.length, STANDARD_STREAMS_ALIASES.length)
    : STANDARD_STREAMS_ALIASES.length;

const normalizeFdSpecificValue = (optionValue, optionArray, optionName) =>
...
const compareFdName = (fdNameA, fdNameB) =>
...
const addDefaultValue = (optionArray, optionName) =>
...
export const getFdSpecificValue = (optionArray, fdNumber) =>
