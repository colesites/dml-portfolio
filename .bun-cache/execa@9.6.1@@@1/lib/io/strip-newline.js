...
export const stripNewline = (value, { stripFinalNewline }, fdNumber) =>
  getStripFinalNewline(stripFinalNewline, fdNumber) &&
  value !== undefined &&
  !Array.isArray(value)
...
export const getStripFinalNewline = (stripFinalNewline, fdNumber) =>
  fdNumber === "all"
