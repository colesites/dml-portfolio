...
import { finalChunksSync, transformChunkSync } from "../transform/run-sync.js";
...
export const iterateOnSubprocessStream = ({
  subprocessStdout,
  subprocess,
  binary,
  shouldEncode,
...
const iterateOnData = async function* ({
  onStdoutChunk,
  controller,
  binary,
  shouldEncode,
