...
declare function getDefaultAgent(
...
declare function detect({
  ...
  programmatic,
  cwd,
}?: DetectOptions): Promise<package_manager_detector.Agent | undefined>;
...
declare function getCliCommand(
  fn: Runner,
  args: string[],
  options?: DetectOptions,
  cwd?: string,
...
declare function serializeCommand(
 ...
 */
declare function writeFileSafe(
  path: string,
  data?: string | Buffer,
): Promise<boolean>;
declare function limitText(text: string, maxWidth: number): string;
declare function formatPackageWithUrl(
  pkg: string,
  url?: string,
  limits?: number,
): string;
