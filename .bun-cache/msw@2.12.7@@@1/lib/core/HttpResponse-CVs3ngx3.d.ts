 ...
 */
declare const executeHandlers: <Handlers extends Array<RequestHandler>>({
  request,
  requestId,
  handlers,
  resolutionContext,
 ...
 */
declare function parseGraphQLRequest(
  request: Request,
): Promise<ParsedGraphQLRequest>;

interface DocumentTypeDecoration<
  Result = {
    [key: string]: any;
  },
  Variables = {
...
type GraphQLCustomPredicateResult =
  | boolean
  | {
      matches: boolean;
    };
type GraphQLPredicate<Query = any, Variables = any> =
...
declare class GraphQLHandler extends RequestHandler<
  GraphQLHandlerInfo,
...
> =
  ...
  | undefined
  | void;
type MaybeAsyncResponseResolverReturnType<
...
interface RequestHandlerExecutionResult<
...
export {
  type AsyncResponseResolverReturnType as A,
  parseGraphQLRequest as B,
  type DocumentTypeDecoration as C,
  type DefaultBodyType as D,
  type GraphQLHandlerNameSelector as E,
  type GraphQLHandlerInfo as F,
  GraphQLHandler as G,
  type HttpResponseInit as H,
  type GraphQLRequestParsedResult as I,
  type JsonBodyType as J,
  type GraphQLCustomPredicateResult as K,
  isDocumentNode as L,
  type RequestHandlerInternalInfo as M,
  type MaybeAsyncResponseResolverReturnType as N,
  type RequestHandlerArgs as O,
  type ParsedGraphQLRequest as P,
  type RequestHandlerExecutionResult as Q,
  RequestHandler as R,
  type StrictRequest as S,
  type ResponseResolver as a,
  type ResponseResolverReturnType as b,
  type RequestHandlerOptions as c,
  type DefaultRequestMultipartBody as d,
  type ResponseResolverInfo as e,
  type GraphQLQuery as f,
  type GraphQLVariables as g,
  type GraphQLRequestBody as h,
  type GraphQLResponseBody as i,
  type GraphQLJsonRequestBody as j,
  type GraphQLOperationType as k,
  type GraphQLCustomPredicate as l,
  type ResponseResolutionContext as m,
  bodyType as n,
  type DefaultUnsafeFetchResponse as o,
  type StrictResponse as p,
  HttpResponse as q,
  type GraphQLPredicate as r,
  type GraphQLResolverExtras as s,
  type RequestHandlerDefaultInfo as t,
  type HandlersExecutionResult as u,
  executeHandlers as v,
  type ParsedGraphQLQuery as w,
  parseDocumentNode as x,
  type GraphQLParsedOperationsMap as y,
  type GraphQLMultipartRequestBody as z,
};
